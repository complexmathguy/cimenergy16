...
echo 'add a remote pseudo for the cimenergy16 repository'

git remote add origin https://complexmathguy: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@github.com/complexmathguy/cimenergy16
