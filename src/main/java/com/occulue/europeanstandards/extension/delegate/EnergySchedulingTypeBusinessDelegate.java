 ...
 *   <li>Improving the available of EnergySchedulingType related services in the case of a
 *       EnergySchedulingType business related service failing.
 *   <li>Exposes a simpler, uniform EnergySchedulingType interface to the business tier, making it
 *       easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill EnergySchedulingType
 ...
 */
public class EnergySchedulingTypeBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createEnergySchedulingType(
      CreateEnergySchedulingTypeCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateEnergySchedulingTypeCommand - by convention the future return value for a
      // create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateEnergySchedulingTypeCommand of EnergySchedulingType is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateEnergySchedulingType(
      UpdateEnergySchedulingTypeCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteEnergySchedulingTypeCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete EnergySchedulingType using Id = " + command.getEnergySchedulingTypeId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
  ...
  public EnergySchedulingType getEnergySchedulingType(EnergySchedulingTypeFetchOneSummary summary)
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<EnergySchedulingType> futureEntity =
          queryGateway.query(
              new FindEnergySchedulingTypeQuery(
                  new LoadEnergySchedulingTypeFilter(summary.getEnergySchedulingTypeId())),
              ResponseTypes.instanceOf(EnergySchedulingType.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate EnergySchedulingType with id " + summary.getEnergySchedulingTypeId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
   ...
   */
  public List<EnergySchedulingType> getAllEnergySchedulingType() throws ProcessingException {
    List<EnergySchedulingType> list = null;

    try {
      CompletableFuture<List<EnergySchedulingType>> futureList =
          queryGateway.query(
              new FindAllEnergySchedulingTypeQuery(),
              ResponseTypes.multipleInstancesOf(EnergySchedulingType.class));
   ...
   */
  private EnergySchedulingType load(UUID id) throws ProcessingException {
    energySchedulingType =
        EnergySchedulingTypeBusinessDelegate.getEnergySchedulingTypeInstance()
            .getEnergySchedulingType(new EnergySchedulingTypeFetchOneSummary(id));
    return energySchedulingType;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(EnergySchedulingTypeBusinessDelegate.class.getName());
}
