 ...
 *   <li>Improving the available of ENTSOEConnectivityNode related services in the case of a
 *       ENTSOEConnectivityNode business related service failing.
 *   <li>Exposes a simpler, uniform ENTSOEConnectivityNode interface to the business tier, making it
 *       easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill ENTSOEConnectivityNode
 ...
 */
public class ENTSOEConnectivityNodeBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createENTSOEConnectivityNode(
      CreateENTSOEConnectivityNodeCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateENTSOEConnectivityNodeCommand - by convention the future return value for a
      // create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateENTSOEConnectivityNodeCommand of ENTSOEConnectivityNode is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateENTSOEConnectivityNode(
      UpdateENTSOEConnectivityNodeCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteENTSOEConnectivityNodeCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete ENTSOEConnectivityNode using Id = "
              + command.getENTSOEConnectivityNodeId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
   ...
   * @exception IllegalArgumentException
   */
  public ENTSOEConnectivityNode getENTSOEConnectivityNode(
      ENTSOEConnectivityNodeFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "ENTSOEConnectivityNodeFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<ENTSOEConnectivityNode> futureEntity =
          queryGateway.query(
              new FindENTSOEConnectivityNodeQuery(
                  new LoadENTSOEConnectivityNodeFilter(summary.getENTSOEConnectivityNodeId())),
              ResponseTypes.instanceOf(ENTSOEConnectivityNode.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate ENTSOEConnectivityNode with id "
   ...
   */
  public List<ENTSOEConnectivityNode> getAllENTSOEConnectivityNode() throws ProcessingException {
    List<ENTSOEConnectivityNode> list = null;

    try {
      CompletableFuture<List<ENTSOEConnectivityNode>> futureList =
          queryGateway.query(
   ...
   */
  private ENTSOEConnectivityNode load(UUID id) throws ProcessingException {
    eNTSOEConnectivityNode =
        ENTSOEConnectivityNodeBusinessDelegate.getENTSOEConnectivityNodeInstance()
            .getENTSOEConnectivityNode(new ENTSOEConnectivityNodeFetchOneSummary(id));
    return eNTSOEConnectivityNode;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ENTSOEConnectivityNodeBusinessDelegate.class.getName());
}
