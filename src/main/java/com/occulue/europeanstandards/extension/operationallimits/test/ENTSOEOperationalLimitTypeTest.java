 ...
 ******************************************************************************/
package com.occulue.europeanstandards.extension.operationallimits.test;
...
import com.occulue.europeanstandards.extension.operationallimits.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.extension.operationallimits.subscriber.*;
...
public class ENTSOEOperationalLimitTypeTest{
	 ...
	 */
	publics ENTSOEOperationalLimitTypeTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateENTSOEOperationalLimitTypeCommand generateNewCommand() {
        CreateENTSOEOperationalLimitTypeCommand command = new CreateENTSOEOperationalLimitTypeCommand( null,  LimitTypeKind.values()[0] );
	...
	protected UpdateENTSOEOperationalLimitTypeCommand generateUpdateCommand() {
	        UpdateENTSOEOperationalLimitTypeCommand command = new UpdateENTSOEOperationalLimitTypeCommand( null,  LimitTypeKind.values()[0] );
