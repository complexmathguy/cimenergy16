 ...
 * ****************************************************************************
 */
package com.occulue.europeanstandards.extension.operationallimits.delegate;

import com.occulue.api.*;
import com.occulue.delegate.*;
import com.occulue.entity.*;
import com.occulue.europeanstandards.extension.operationallimits.validator.*;
 ...
 *   <li>Improving the available of ENTSOEOperationalLimitType related services in the case of a
 *       ENTSOEOperationalLimitType business related service failing.
 *   <li>Exposes a simpler, uniform ENTSOEOperationalLimitType interface to the business tier,
 *       making it easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill ENTSOEOperationalLimitType
 ...
 */
public class ENTSOEOperationalLimitTypeBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createENTSOEOperationalLimitType(
      CreateENTSOEOperationalLimitTypeCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateENTSOEOperationalLimitTypeCommand - by convention the future return value
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateENTSOEOperationalLimitTypeCommand of ENTSOEOperationalLimitType is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateENTSOEOperationalLimitType(
      UpdateENTSOEOperationalLimitTypeCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteENTSOEOperationalLimitTypeCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete ENTSOEOperationalLimitType using Id = "
              + command.getENTSOEOperationalLimitTypeId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
   ...
   * @exception IllegalArgumentException
   */
  public ENTSOEOperationalLimitType getENTSOEOperationalLimitType(
      ENTSOEOperationalLimitTypeFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "ENTSOEOperationalLimitTypeFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<ENTSOEOperationalLimitType> futureEntity =
          queryGateway.query(
              new FindENTSOEOperationalLimitTypeQuery(
                  new LoadENTSOEOperationalLimitTypeFilter(
                      summary.getENTSOEOperationalLimitTypeId())),
              ResponseTypes.instanceOf(ENTSOEOperationalLimitType.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate ENTSOEOperationalLimitType with id "
              + summary.getENTSOEOperationalLimitTypeId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
  ...
  public List<ENTSOEOperationalLimitType> getAllENTSOEOperationalLimitType()
    ...
    try {
      CompletableFuture<List<ENTSOEOperationalLimitType>> futureList =
          queryGateway.query(
   ...
   */
  private ENTSOEOperationalLimitType load(UUID id) throws ProcessingException {
    eNTSOEOperationalLimitType =
        ENTSOEOperationalLimitTypeBusinessDelegate.getENTSOEOperationalLimitTypeInstance()
            .getENTSOEOperationalLimitType(new ENTSOEOperationalLimitTypeFetchOneSummary(id));
    return eNTSOEOperationalLimitType;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ENTSOEOperationalLimitTypeBusinessDelegate.class.getName());
}
