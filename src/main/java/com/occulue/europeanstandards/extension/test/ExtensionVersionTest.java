...
public class ExtensionVersionTest{
	 ...
	 */
	publics ExtensionVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExtensionVersionCommand generateNewCommand() {
        CreateExtensionVersionCommand command = new CreateExtensionVersionCommand( null );
	...
	protected UpdateExtensionVersionCommand generateUpdateCommand() {
	        UpdateExtensionVersionCommand command = new UpdateExtensionVersionCommand( null,  null,  null );
