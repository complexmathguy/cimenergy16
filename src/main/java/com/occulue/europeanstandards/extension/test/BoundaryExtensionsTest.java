 ...
 ******************************************************************************/
package com.occulue.europeanstandards.extension.test;
...
import com.occulue.europeanstandards.extension.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.extension.subscriber.*;
...
public class BoundaryExtensionsTest{
	 ...
	 */
	publics BoundaryExtensionsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateBoundaryExtensionsCommand generateNewCommand() {
        CreateBoundaryExtensionsCommand command = new CreateBoundaryExtensionsCommand( null );
	...
	protected UpdateBoundaryExtensionsCommand generateUpdateCommand() {
	        UpdateBoundaryExtensionsCommand command = new UpdateBoundaryExtensionsCommand( null,  null,  null,  null,  null,  null,  null,  null );
