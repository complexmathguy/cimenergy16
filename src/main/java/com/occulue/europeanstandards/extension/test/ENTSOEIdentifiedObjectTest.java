...
public class ENTSOEIdentifiedObjectTest{
	 ...
	 */
	publics ENTSOEIdentifiedObjectTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateENTSOEIdentifiedObjectCommand generateNewCommand() {
        CreateENTSOEIdentifiedObjectCommand command = new CreateENTSOEIdentifiedObjectCommand( null );
	...
	protected UpdateENTSOEIdentifiedObjectCommand generateUpdateCommand() {
	        UpdateENTSOEIdentifiedObjectCommand command = new UpdateENTSOEIdentifiedObjectCommand( null,  null,  null );
