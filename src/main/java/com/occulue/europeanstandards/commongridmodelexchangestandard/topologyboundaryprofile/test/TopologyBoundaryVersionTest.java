 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.topologyboundaryprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.topologyboundaryprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.topologyboundaryprofile.subscriber.*;
...
public class TopologyBoundaryVersionTest{
	 ...
	 */
	publics TopologyBoundaryVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTopologyBoundaryVersionCommand generateNewCommand() {
        CreateTopologyBoundaryVersionCommand command = new CreateTopologyBoundaryVersionCommand( null );
	...
	protected UpdateTopologyBoundaryVersionCommand generateUpdateCommand() {
	        UpdateTopologyBoundaryVersionCommand command = new UpdateTopologyBoundaryVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
