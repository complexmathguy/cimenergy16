 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.topologyboundaryprofile.topology.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.topologyboundaryprofile.topology.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.topologyboundaryprofile.topology.subscriber.*;
...
public class TopologicalNodeTest{
	 ...
	 */
	publics TopologicalNodeTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTopologicalNodeCommand generateNewCommand() {
        CreateTopologicalNodeCommand command = new CreateTopologicalNodeCommand( null );
	...
	protected UpdateTopologicalNodeCommand generateUpdateCommand() {
	        UpdateTopologicalNodeCommand command = new UpdateTopologicalNodeCommand( null,  null,  null,  null,  null,  null,  null,  null,  new HashSet<>() );
