...
public class DiagramObjectPointTest{
	 ...
	 */
	publics DiagramObjectPointTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDiagramObjectPointCommand generateNewCommand() {
        CreateDiagramObjectPointCommand command = new CreateDiagramObjectPointCommand( null );
	...
	protected UpdateDiagramObjectPointCommand generateUpdateCommand() {
	        UpdateDiagramObjectPointCommand command = new UpdateDiagramObjectPointCommand( null,  null,  null,  null,  null,  new HashSet<>() );
