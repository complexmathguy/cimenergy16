 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.diagramlayoutprofile.diagramlayout.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.diagramlayoutprofile.diagramlayout.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.diagramlayoutprofile.diagramlayout.subscriber.*;
...
public class DiagramObjectTest{
	 ...
	 */
	publics DiagramObjectTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDiagramObjectCommand generateNewCommand() {
        CreateDiagramObjectCommand command = new CreateDiagramObjectCommand( null );
	...
	protected UpdateDiagramObjectCommand generateUpdateCommand() {
	        UpdateDiagramObjectCommand command = new UpdateDiagramObjectCommand( null,  null,  null,  null,  null,  null,  new HashSet<>(),  new HashSet<>(),  new HashSet<>() );
