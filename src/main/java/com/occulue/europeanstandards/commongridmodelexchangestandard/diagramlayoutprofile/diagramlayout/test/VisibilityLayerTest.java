...
public class VisibilityLayerTest{
	 ...
	 */
	publics VisibilityLayerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVisibilityLayerCommand generateNewCommand() {
        CreateVisibilityLayerCommand command = new CreateVisibilityLayerCommand( null );
	...
	protected UpdateVisibilityLayerCommand generateUpdateCommand() {
	        UpdateVisibilityLayerCommand command = new UpdateVisibilityLayerCommand( null,  null,  new HashSet<>() );
