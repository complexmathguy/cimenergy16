 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.diagramlayoutprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.diagramlayoutprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.diagramlayoutprofile.subscriber.*;
...
public class DiagramLayoutVersionTest{
	 ...
	 */
	publics DiagramLayoutVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDiagramLayoutVersionCommand generateNewCommand() {
        CreateDiagramLayoutVersionCommand command = new CreateDiagramLayoutVersionCommand( null );
	...
	protected UpdateDiagramLayoutVersionCommand generateUpdateCommand() {
	        UpdateDiagramLayoutVersionCommand command = new UpdateDiagramLayoutVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
