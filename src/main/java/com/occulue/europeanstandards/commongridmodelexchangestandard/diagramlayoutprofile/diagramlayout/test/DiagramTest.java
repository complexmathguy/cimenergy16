...
public class DiagramTest{
	 ...
	 * @return		DiagramTest
	 */
	publics DiagramTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDiagramCommand generateNewCommand() {
        CreateDiagramCommand command = new CreateDiagramCommand( null,  OrientationKind.values()[0] );
	...
	protected UpdateDiagramCommand generateUpdateCommand() {
	        UpdateDiagramCommand command = new UpdateDiagramCommand( null,  OrientationKind.values()[0],  null,  null,  null,  null,  new HashSet<>() );
