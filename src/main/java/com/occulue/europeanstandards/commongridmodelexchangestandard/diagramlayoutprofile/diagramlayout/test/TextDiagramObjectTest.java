...
public class TextDiagramObjectTest{
	 ...
	 */
	publics TextDiagramObjectTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTextDiagramObjectCommand generateNewCommand() {
        CreateTextDiagramObjectCommand command = new CreateTextDiagramObjectCommand( null );
	...
	protected UpdateTextDiagramObjectCommand generateUpdateCommand() {
	        UpdateTextDiagramObjectCommand command = new UpdateTextDiagramObjectCommand( null,  null );
