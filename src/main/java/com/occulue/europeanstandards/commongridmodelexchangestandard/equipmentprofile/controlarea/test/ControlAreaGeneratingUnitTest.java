...
public class ControlAreaGeneratingUnitTest{
	 ...
	 */
	publics ControlAreaGeneratingUnitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateControlAreaGeneratingUnitCommand generateUpdateCommand() {
	        UpdateControlAreaGeneratingUnitCommand command = new UpdateControlAreaGeneratingUnitCommand( null,  new HashSet<>() );
