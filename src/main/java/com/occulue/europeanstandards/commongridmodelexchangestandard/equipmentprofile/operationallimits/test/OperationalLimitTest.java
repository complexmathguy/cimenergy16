...
public class OperationalLimitTest{
	 ...
	 */
	publics OperationalLimitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateOperationalLimitCommand generateUpdateCommand() {
	        UpdateOperationalLimitCommand command = new UpdateOperationalLimitCommand( null,  new HashSet<>(),  new HashSet<>() );
