...
public class TieFlowTest{
	 ...
	 * @return		TieFlowTest
	 */
	publics TieFlowTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTieFlowCommand generateNewCommand() {
        CreateTieFlowCommand command = new CreateTieFlowCommand( null );
	...
	protected UpdateTieFlowCommand generateUpdateCommand() {
	        UpdateTieFlowCommand command = new UpdateTieFlowCommand( null,  null,  new HashSet<>() );
