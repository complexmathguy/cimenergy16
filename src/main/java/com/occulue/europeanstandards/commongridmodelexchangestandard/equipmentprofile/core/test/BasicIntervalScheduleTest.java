 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.core.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.core.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.core.subscriber.*;
...
public class BasicIntervalScheduleTest{
	 ...
	 */
	publics BasicIntervalScheduleTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateBasicIntervalScheduleCommand generateNewCommand() {
        CreateBasicIntervalScheduleCommand command = new CreateBasicIntervalScheduleCommand( null,  UnitSymbol.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateBasicIntervalScheduleCommand generateUpdateCommand() {
	        UpdateBasicIntervalScheduleCommand command = new UpdateBasicIntervalScheduleCommand( null,  null,  UnitSymbol.values()[0],  UnitSymbol.values()[0] );
