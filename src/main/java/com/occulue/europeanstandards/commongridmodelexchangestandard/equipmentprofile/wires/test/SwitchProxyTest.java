...
public class SwitchProxyTest{
	 ...
	 */
	publics SwitchProxyTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSwitchProxyCommand generateNewCommand() {
        CreateSwitchProxyCommand command = new CreateSwitchProxyCommand( null );
	...
	protected UpdateSwitchProxyCommand generateUpdateCommand() {
	        UpdateSwitchProxyCommand command = new UpdateSwitchProxyCommand( null,  null,  null,  null );
