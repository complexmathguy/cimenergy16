...
public class PowerTransformerTest{
	 ...
	 */
	publics PowerTransformerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePowerTransformerCommand generateNewCommand() {
        CreatePowerTransformerCommand command = new CreatePowerTransformerCommand( null );
	...
	protected UpdatePowerTransformerCommand generateUpdateCommand() {
	        UpdatePowerTransformerCommand command = new UpdatePowerTransformerCommand( null,  null,  null,  null,  null,  null,  null );
