...
public class MeasurementValueQualityTest{
	 ...
	 */
	publics MeasurementValueQualityTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateMeasurementValueQualityCommand generateUpdateCommand() {
	        UpdateMeasurementValueQualityCommand command = new UpdateMeasurementValueQualityCommand( null,  null );
