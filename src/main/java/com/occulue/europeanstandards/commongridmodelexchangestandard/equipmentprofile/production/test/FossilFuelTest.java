...
public class FossilFuelTest{
	 ...
	 */
	publics FossilFuelTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateFossilFuelCommand generateNewCommand() {
        CreateFossilFuelCommand command = new CreateFossilFuelCommand( null,  FuelType.values()[0] );
	...
	protected UpdateFossilFuelCommand generateUpdateCommand() {
	        UpdateFossilFuelCommand command = new UpdateFossilFuelCommand( null,  FuelType.values()[0],  new HashSet<>() );
