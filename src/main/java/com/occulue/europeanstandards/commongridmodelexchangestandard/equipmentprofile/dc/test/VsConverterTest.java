...
public class VsConverterTest{
	 ...
	 */
	publics VsConverterTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVsConverterCommand generateNewCommand() {
        CreateVsConverterCommand command = new CreateVsConverterCommand( null );
	...
	protected UpdateVsConverterCommand generateUpdateCommand() {
	        UpdateVsConverterCommand command = new UpdateVsConverterCommand( null,  null,  null,  new HashSet<>() );
