 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.subscriber.*;
...
public class EquipmentVersionTest{
	 ...
	 */
	publics EquipmentVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateEquipmentVersionCommand generateNewCommand() {
        CreateEquipmentVersionCommand command = new CreateEquipmentVersionCommand( null );
	...
	protected UpdateEquipmentVersionCommand generateUpdateCommand() {
	        UpdateEquipmentVersionCommand command = new UpdateEquipmentVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
