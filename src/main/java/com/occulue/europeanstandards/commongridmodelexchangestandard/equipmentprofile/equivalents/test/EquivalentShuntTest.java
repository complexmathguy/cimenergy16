...
public class EquivalentShuntTest{
	 ...
	 */
	publics EquivalentShuntTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateEquivalentShuntCommand generateNewCommand() {
        CreateEquivalentShuntCommand command = new CreateEquivalentShuntCommand( null );
	...
	protected UpdateEquivalentShuntCommand generateUpdateCommand() {
	        UpdateEquivalentShuntCommand command = new UpdateEquivalentShuntCommand( null,  null,  null );
