...
public class WindGeneratingUnitTest{
	 ...
	 */
	publics WindGeneratingUnitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindGeneratingUnitCommand generateNewCommand() {
        CreateWindGeneratingUnitCommand command = new CreateWindGeneratingUnitCommand( null,  WindGenUnitKind.values()[0] );
	...
	protected UpdateWindGeneratingUnitCommand generateUpdateCommand() {
	        UpdateWindGeneratingUnitCommand command = new UpdateWindGeneratingUnitCommand( null,  WindGenUnitKind.values()[0] );
