...
public class AnalogControlTest{
	 ...
	 */
	publics AnalogControlTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAnalogControlCommand generateNewCommand() {
        CreateAnalogControlCommand command = new CreateAnalogControlCommand( null );
	...
	protected UpdateAnalogControlCommand generateUpdateCommand() {
	        UpdateAnalogControlCommand command = new UpdateAnalogControlCommand( null,  null,  null,  null );
