...
public class NonlinearShuntCompensatorPointTest{
	 ...
	 */
	publics NonlinearShuntCompensatorPointTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateNonlinearShuntCompensatorPointCommand generateNewCommand() {
        CreateNonlinearShuntCompensatorPointCommand command = new CreateNonlinearShuntCompensatorPointCommand( null );
	...
	protected UpdateNonlinearShuntCompensatorPointCommand generateUpdateCommand() {
	        UpdateNonlinearShuntCompensatorPointCommand command = new UpdateNonlinearShuntCompensatorPointCommand( null,  null,  null,  null,  null,  null,  new HashSet<>() );
