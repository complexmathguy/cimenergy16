...
public class AnalogLimitTest{
	 ...
	 */
	publics AnalogLimitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAnalogLimitCommand generateNewCommand() {
        CreateAnalogLimitCommand command = new CreateAnalogLimitCommand( null );
	...
	protected UpdateAnalogLimitCommand generateUpdateCommand() {
	        UpdateAnalogLimitCommand command = new UpdateAnalogLimitCommand( null,  null,  new HashSet<>() );
