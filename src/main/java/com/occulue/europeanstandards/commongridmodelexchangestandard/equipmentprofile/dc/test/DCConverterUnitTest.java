...
public class DCConverterUnitTest{
	 ...
	 */
	publics DCConverterUnitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDCConverterUnitCommand generateNewCommand() {
        CreateDCConverterUnitCommand command = new CreateDCConverterUnitCommand( null,  DCConverterOperatingModeKind.values()[0] );
	...
	protected UpdateDCConverterUnitCommand generateUpdateCommand() {
	        UpdateDCConverterUnitCommand command = new UpdateDCConverterUnitCommand( null,  DCConverterOperatingModeKind.values()[0],  new HashSet<>() );
