 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.loadmodel.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.loadmodel.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.loadmodel.subscriber.*;
...
public class LoadResponseCharacteristicTest{
	 ...
	 */
	publics LoadResponseCharacteristicTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLoadResponseCharacteristicCommand generateNewCommand() {
        CreateLoadResponseCharacteristicCommand command = new CreateLoadResponseCharacteristicCommand( null );
	...
	protected UpdateLoadResponseCharacteristicCommand generateUpdateCommand() {
	        UpdateLoadResponseCharacteristicCommand command = new UpdateLoadResponseCharacteristicCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
