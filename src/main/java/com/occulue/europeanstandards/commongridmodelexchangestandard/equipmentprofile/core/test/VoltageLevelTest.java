...
public class VoltageLevelTest{
	 ...
	 */
	publics VoltageLevelTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVoltageLevelCommand generateNewCommand() {
        CreateVoltageLevelCommand command = new CreateVoltageLevelCommand( null );
	...
	protected UpdateVoltageLevelCommand generateUpdateCommand() {
	        UpdateVoltageLevelCommand command = new UpdateVoltageLevelCommand( null,  null,  null,  new HashSet<>(),  new HashSet<>() );
