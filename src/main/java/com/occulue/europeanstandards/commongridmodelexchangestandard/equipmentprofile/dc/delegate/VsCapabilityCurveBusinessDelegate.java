 ...
 *   <li>Improving the available of VsCapabilityCurve related services in the case of a
 *       VsCapabilityCurve business related service failing.
 *   <li>Exposes a simpler, uniform VsCapabilityCurve interface to the business tier, making it easy
 *       for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill VsCapabilityCurve business
 *       related services.
 * </ol>
 *
 * <p>
 ...
 */
public class VsCapabilityCurveBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
  ...
  public CompletableFuture<UUID> createVsCapabilityCurve(CreateVsCapabilityCurveCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateVsCapabilityCurveCommand - by convention the future return value for a
      // create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateVsCapabilityCurveCommand of VsCapabilityCurve is "
              + command);
  ...
  public CompletableFuture<Void> delete(DeleteVsCapabilityCurveCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete VsCapabilityCurve using Id = " + command.getVsCapabilityCurveId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
  ...
  public VsCapabilityCurve getVsCapabilityCurve(VsCapabilityCurveFetchOneSummary summary)
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<VsCapabilityCurve> futureEntity =
          queryGateway.query(
              new FindVsCapabilityCurveQuery(
                  new LoadVsCapabilityCurveFilter(summary.getVsCapabilityCurveId())),
              ResponseTypes.instanceOf(VsCapabilityCurve.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate VsCapabilityCurve with id " + summary.getVsCapabilityCurveId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
   ...
   */
  public List<VsCapabilityCurve> getAllVsCapabilityCurve() throws ProcessingException {
    List<VsCapabilityCurve> list = null;

    try {
      CompletableFuture<List<VsCapabilityCurve>> futureList =
          queryGateway.query(
   ...
   */
  private VsCapabilityCurve load(UUID id) throws ProcessingException {
    vsCapabilityCurve =
        VsCapabilityCurveBusinessDelegate.getVsCapabilityCurveInstance()
            .getVsCapabilityCurve(new VsCapabilityCurveFetchOneSummary(id));
    return vsCapabilityCurve;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(VsCapabilityCurveBusinessDelegate.class.getName());
}
