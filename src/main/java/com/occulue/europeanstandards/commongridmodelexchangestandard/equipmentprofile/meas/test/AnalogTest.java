...
public class AnalogTest{
	 ...
	 * @return		AnalogTest
	 */
	publics AnalogTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAnalogCommand generateNewCommand() {
        CreateAnalogCommand command = new CreateAnalogCommand( null );
	...
	protected UpdateAnalogCommand generateUpdateCommand() {
	        UpdateAnalogCommand command = new UpdateAnalogCommand( null,  null );
