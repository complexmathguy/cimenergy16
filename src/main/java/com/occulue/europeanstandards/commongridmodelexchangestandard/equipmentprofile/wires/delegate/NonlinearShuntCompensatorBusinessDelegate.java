 ...
 *   <li>Improving the available of NonlinearShuntCompensator related services in the case of a
 *       NonlinearShuntCompensator business related service failing.
 *   <li>Exposes a simpler, uniform NonlinearShuntCompensator interface to the business tier, making
 *       it easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill NonlinearShuntCompensator
 ...
 */
public class NonlinearShuntCompensatorBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createNonlinearShuntCompensator(
      CreateNonlinearShuntCompensatorCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateNonlinearShuntCompensatorCommand - by convention the future return value
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateNonlinearShuntCompensatorCommand of NonlinearShuntCompensator is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateNonlinearShuntCompensator(
      UpdateNonlinearShuntCompensatorCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteNonlinearShuntCompensatorCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete NonlinearShuntCompensator using Id = "
              + command.getNonlinearShuntCompensatorId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
  ...
  public NonlinearShuntCompensator getNonlinearShuntCompensator(
      NonlinearShuntCompensatorFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "NonlinearShuntCompensatorFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<NonlinearShuntCompensator> futureEntity =
          queryGateway.query(
              new FindNonlinearShuntCompensatorQuery(
                  new LoadNonlinearShuntCompensatorFilter(
      ...
      final String errMsg =
          "Unable to locate NonlinearShuntCompensator with id "
              + summary.getNonlinearShuntCompensatorId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
  ...
  public List<NonlinearShuntCompensator> getAllNonlinearShuntCompensator()
    ...
    try {
      CompletableFuture<List<NonlinearShuntCompensator>> futureList =
          queryGateway.query(
   ...
   */
  private NonlinearShuntCompensator load(UUID id) throws ProcessingException {
    nonlinearShuntCompensator =
        NonlinearShuntCompensatorBusinessDelegate.getNonlinearShuntCompensatorInstance()
            .getNonlinearShuntCompensator(new NonlinearShuntCompensatorFetchOneSummary(id));
    return nonlinearShuntCompensator;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(NonlinearShuntCompensatorBusinessDelegate.class.getName());
}
