...
public class RegularTimePointTest{
	 ...
	 */
	publics RegularTimePointTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateRegularTimePointCommand generateNewCommand() {
        CreateRegularTimePointCommand command = new CreateRegularTimePointCommand( null );
	...
	protected UpdateRegularTimePointCommand generateUpdateCommand() {
	        UpdateRegularTimePointCommand command = new UpdateRegularTimePointCommand( null,  null,  null,  null,  new HashSet<>() );
