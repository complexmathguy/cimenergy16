...
public class DiscreteValueTest{
	 ...
	 */
	publics DiscreteValueTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDiscreteValueCommand generateNewCommand() {
        CreateDiscreteValueCommand command = new CreateDiscreteValueCommand( null );
	...
	protected UpdateDiscreteValueCommand generateUpdateCommand() {
	        UpdateDiscreteValueCommand command = new UpdateDiscreteValueCommand( null,  null,  new HashSet<>() );
