...
public class StringMeasurementValueTest{
	 ...
	 */
	publics StringMeasurementValueTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateStringMeasurementValueCommand generateNewCommand() {
        CreateStringMeasurementValueCommand command = new CreateStringMeasurementValueCommand( null );
	...
	protected UpdateStringMeasurementValueCommand generateUpdateCommand() {
	        UpdateStringMeasurementValueCommand command = new UpdateStringMeasurementValueCommand( null,  null,  new HashSet<>() );
