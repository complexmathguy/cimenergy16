...
public class ControlTest{
	 ...
	 * @return		ControlTest
	 */
	publics ControlTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateControlCommand generateNewCommand() {
        CreateControlCommand command = new CreateControlCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateControlCommand generateUpdateCommand() {
	        UpdateControlCommand command = new UpdateControlCommand( null,  null,  null,  null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  new HashSet<>() );
