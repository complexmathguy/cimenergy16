 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.production.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.production.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.production.subscriber.*;
...
public class GeneratingUnitTest{
	 ...
	 */
	publics GeneratingUnitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGeneratingUnitCommand generateNewCommand() {
        CreateGeneratingUnitCommand command = new CreateGeneratingUnitCommand( null,  GeneratorControlSource.values()[0] );
	...
	protected UpdateGeneratingUnitCommand generateUpdateCommand() {
	        UpdateGeneratingUnitCommand command = new UpdateGeneratingUnitCommand( null,  GeneratorControlSource.values()[0],  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
