...
public class PerLengthDCLineParameterTest{
	 ...
	 */
	publics PerLengthDCLineParameterTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePerLengthDCLineParameterCommand generateNewCommand() {
        CreatePerLengthDCLineParameterCommand command = new CreatePerLengthDCLineParameterCommand( null );
	...
	protected UpdatePerLengthDCLineParameterCommand generateUpdateCommand() {
	        UpdatePerLengthDCLineParameterCommand command = new UpdatePerLengthDCLineParameterCommand( null,  null,  null,  null );
