...
public class CurrentLimitTest{
	 ...
	 */
	publics CurrentLimitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCurrentLimitCommand generateNewCommand() {
        CreateCurrentLimitCommand command = new CreateCurrentLimitCommand( null );
	...
	protected UpdateCurrentLimitCommand generateUpdateCommand() {
	        UpdateCurrentLimitCommand command = new UpdateCurrentLimitCommand( null,  null );
