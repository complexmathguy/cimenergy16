...
public class AccumulatorValueTest{
	 ...
	 */
	publics AccumulatorValueTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAccumulatorValueCommand generateNewCommand() {
        CreateAccumulatorValueCommand command = new CreateAccumulatorValueCommand( null );
	...
	protected UpdateAccumulatorValueCommand generateUpdateCommand() {
	        UpdateAccumulatorValueCommand command = new UpdateAccumulatorValueCommand( null,  null,  new HashSet<>() );
