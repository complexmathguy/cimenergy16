...
public class HydroPowerPlantTest{
	 ...
	 */
	publics HydroPowerPlantTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateHydroPowerPlantCommand generateNewCommand() {
        CreateHydroPowerPlantCommand command = new CreateHydroPowerPlantCommand( null,  HydroPlantStorageKind.values()[0] );
	...
	protected UpdateHydroPowerPlantCommand generateUpdateCommand() {
	        UpdateHydroPowerPlantCommand command = new UpdateHydroPowerPlantCommand( null,  HydroPlantStorageKind.values()[0] );
