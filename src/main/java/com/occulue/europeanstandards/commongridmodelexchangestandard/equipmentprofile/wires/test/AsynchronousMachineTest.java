...
public class AsynchronousMachineTest{
	 ...
	 */
	publics AsynchronousMachineTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAsynchronousMachineCommand generateNewCommand() {
        CreateAsynchronousMachineCommand command = new CreateAsynchronousMachineCommand( null );
	...
	protected UpdateAsynchronousMachineCommand generateUpdateCommand() {
	        UpdateAsynchronousMachineCommand command = new UpdateAsynchronousMachineCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
