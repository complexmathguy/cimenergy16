...
public class CurveTest{
	 ...
	 * @return		CurveTest
	 */
	publics CurveTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCurveCommand generateNewCommand() {
        CreateCurveCommand command = new CreateCurveCommand( null,  CurveStyle.values()[0],  UnitSymbol.values()[0],  UnitSymbol.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateCurveCommand generateUpdateCommand() {
	        UpdateCurveCommand command = new UpdateCurveCommand( null,  CurveStyle.values()[0],  UnitSymbol.values()[0],  UnitSymbol.values()[0],  UnitSymbol.values()[0] );
