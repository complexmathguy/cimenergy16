...
public class CommandTest{
	 ...
	 * @return		CommandTest
	 */
	publics CommandTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCommandCommand generateNewCommand() {
        CreateCommandCommand command = new CreateCommandCommand( null );
	...
	protected UpdateCommandCommand generateUpdateCommand() {
	        UpdateCommandCommand command = new UpdateCommandCommand( null,  null,  null,  new HashSet<>(),  null );
