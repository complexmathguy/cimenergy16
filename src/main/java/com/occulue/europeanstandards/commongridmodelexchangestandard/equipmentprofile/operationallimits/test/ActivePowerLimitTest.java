...
public class ActivePowerLimitTest{
	 ...
	 */
	publics ActivePowerLimitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateActivePowerLimitCommand generateNewCommand() {
        CreateActivePowerLimitCommand command = new CreateActivePowerLimitCommand( null );
	...
	protected UpdateActivePowerLimitCommand generateUpdateCommand() {
	        UpdateActivePowerLimitCommand command = new UpdateActivePowerLimitCommand( null,  null );
