 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.dc.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.dc.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.dc.subscriber.*;
...
public class ACDCConverterDCTerminalTest{
	 ...
	 */
	publics ACDCConverterDCTerminalTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateACDCConverterDCTerminalCommand generateNewCommand() {
        CreateACDCConverterDCTerminalCommand command = new CreateACDCConverterDCTerminalCommand( null,  DCPolarityKind.values()[0] );
	...
	protected UpdateACDCConverterDCTerminalCommand generateUpdateCommand() {
	        UpdateACDCConverterDCTerminalCommand command = new UpdateACDCConverterDCTerminalCommand( null,  DCPolarityKind.values()[0],  new HashSet<>() );
