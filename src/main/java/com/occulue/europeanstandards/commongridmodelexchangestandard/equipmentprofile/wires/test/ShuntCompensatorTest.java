...
public class ShuntCompensatorTest{
	 ...
	 */
	publics ShuntCompensatorTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateShuntCompensatorCommand generateNewCommand() {
        CreateShuntCompensatorCommand command = new CreateShuntCompensatorCommand( null );
	...
	protected UpdateShuntCompensatorCommand generateUpdateCommand() {
	        UpdateShuntCompensatorCommand command = new UpdateShuntCompensatorCommand( null,  null,  null,  null,  null,  null,  null,  null,  null );
