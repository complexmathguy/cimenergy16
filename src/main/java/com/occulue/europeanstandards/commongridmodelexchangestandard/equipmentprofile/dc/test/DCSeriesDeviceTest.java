...
public class DCSeriesDeviceTest{
	 ...
	 */
	publics DCSeriesDeviceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDCSeriesDeviceCommand generateNewCommand() {
        CreateDCSeriesDeviceCommand command = new CreateDCSeriesDeviceCommand( null );
	...
	protected UpdateDCSeriesDeviceCommand generateUpdateCommand() {
	        UpdateDCSeriesDeviceCommand command = new UpdateDCSeriesDeviceCommand( null,  null,  null,  null );
