...
public class ValueToAliasTest{
	 ...
	 */
	publics ValueToAliasTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateValueToAliasCommand generateNewCommand() {
        CreateValueToAliasCommand command = new CreateValueToAliasCommand( null );
	...
	protected UpdateValueToAliasCommand generateUpdateCommand() {
	        UpdateValueToAliasCommand command = new UpdateValueToAliasCommand( null,  null,  new HashSet<>() );
