...
public class DCShuntTest{
	 ...
	 * @return		DCShuntTest
	 */
	publics DCShuntTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDCShuntCommand generateNewCommand() {
        CreateDCShuntCommand command = new CreateDCShuntCommand( null );
	...
	protected UpdateDCShuntCommand generateUpdateCommand() {
	        UpdateDCShuntCommand command = new UpdateDCShuntCommand( null,  null,  null,  null );
