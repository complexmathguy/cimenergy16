...
public class SeasonDayTypeScheduleTest{
	 ...
	 */
	publics SeasonDayTypeScheduleTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateSeasonDayTypeScheduleCommand generateUpdateCommand() {
	        UpdateSeasonDayTypeScheduleCommand command = new UpdateSeasonDayTypeScheduleCommand( null,  new HashSet<>() );
