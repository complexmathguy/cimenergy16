...
public class HydroGeneratingUnitTest{
	 ...
	 */
	publics HydroGeneratingUnitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateHydroGeneratingUnitCommand generateNewCommand() {
        CreateHydroGeneratingUnitCommand command = new CreateHydroGeneratingUnitCommand( null,  HydroEnergyConversionKind.values()[0] );
	...
	protected UpdateHydroGeneratingUnitCommand generateUpdateCommand() {
	        UpdateHydroGeneratingUnitCommand command = new UpdateHydroGeneratingUnitCommand( null,  HydroEnergyConversionKind.values()[0],  new HashSet<>() );
