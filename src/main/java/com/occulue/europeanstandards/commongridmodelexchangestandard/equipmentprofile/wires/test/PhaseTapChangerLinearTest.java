...
public class PhaseTapChangerLinearTest{
	 ...
	 */
	publics PhaseTapChangerLinearTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePhaseTapChangerLinearCommand generateNewCommand() {
        CreatePhaseTapChangerLinearCommand command = new CreatePhaseTapChangerLinearCommand( null );
	...
	protected UpdatePhaseTapChangerLinearCommand generateUpdateCommand() {
	        UpdatePhaseTapChangerLinearCommand command = new UpdatePhaseTapChangerLinearCommand( null,  null,  null,  null );
