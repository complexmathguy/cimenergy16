...
public class NonConformLoadScheduleTest{
	 ...
	 */
	publics NonConformLoadScheduleTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateNonConformLoadScheduleCommand generateUpdateCommand() {
	        UpdateNonConformLoadScheduleCommand command = new UpdateNonConformLoadScheduleCommand( null,  new HashSet<>() );
