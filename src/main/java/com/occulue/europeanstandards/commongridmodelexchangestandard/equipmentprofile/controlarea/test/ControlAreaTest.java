 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.controlarea.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.controlarea.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.controlarea.subscriber.*;
...
public class ControlAreaTest{
	 ...
	 */
	publics ControlAreaTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateControlAreaCommand generateNewCommand() {
        CreateControlAreaCommand command = new CreateControlAreaCommand( null,  ControlAreaTypeKind.values()[0] );
	...
	protected UpdateControlAreaCommand generateUpdateCommand() {
	        UpdateControlAreaCommand command = new UpdateControlAreaCommand( null,  ControlAreaTypeKind.values()[0],  null );
