...
public class EquivalentEquipmentTest{
	 ...
	 */
	publics EquivalentEquipmentTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateEquivalentEquipmentCommand generateUpdateCommand() {
	        UpdateEquivalentEquipmentCommand command = new UpdateEquivalentEquipmentCommand( null,  new HashSet<>() );
