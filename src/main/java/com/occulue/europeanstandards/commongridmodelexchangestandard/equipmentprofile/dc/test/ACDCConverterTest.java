...
public class ACDCConverterTest{
	 ...
	 */
	publics ACDCConverterTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateACDCConverterCommand generateNewCommand() {
        CreateACDCConverterCommand command = new CreateACDCConverterCommand( null );
	...
	protected UpdateACDCConverterCommand generateUpdateCommand() {
	        UpdateACDCConverterCommand command = new UpdateACDCConverterCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  new HashSet<>() );
