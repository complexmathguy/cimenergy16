...
public class ConductorTest{
	 ...
	 */
	publics ConductorTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateConductorCommand generateNewCommand() {
        CreateConductorCommand command = new CreateConductorCommand( null );
	...
	protected UpdateConductorCommand generateUpdateCommand() {
	        UpdateConductorCommand command = new UpdateConductorCommand( null,  null );
