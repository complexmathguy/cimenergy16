...
public class CurveDataTest{
	 ...
	 */
	publics CurveDataTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCurveDataCommand generateNewCommand() {
        CreateCurveDataCommand command = new CreateCurveDataCommand( null );
	...
	protected UpdateCurveDataCommand generateUpdateCommand() {
	        UpdateCurveDataCommand command = new UpdateCurveDataCommand( null,  null,  null,  null,  new HashSet<>() );
