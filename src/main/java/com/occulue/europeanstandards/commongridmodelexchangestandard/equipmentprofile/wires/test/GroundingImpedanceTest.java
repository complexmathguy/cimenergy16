...
public class GroundingImpedanceTest{
	 ...
	 */
	publics GroundingImpedanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGroundingImpedanceCommand generateNewCommand() {
        CreateGroundingImpedanceCommand command = new CreateGroundingImpedanceCommand( null );
	...
	protected UpdateGroundingImpedanceCommand generateUpdateCommand() {
	        UpdateGroundingImpedanceCommand command = new UpdateGroundingImpedanceCommand( null,  null );
