...
public class TransformerEndTest{
	 ...
	 */
	publics TransformerEndTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTransformerEndCommand generateNewCommand() {
        CreateTransformerEndCommand command = new CreateTransformerEndCommand( null );
	...
	protected UpdateTransformerEndCommand generateUpdateCommand() {
	        UpdateTransformerEndCommand command = new UpdateTransformerEndCommand( null,  null,  null,  null,  null,  new HashSet<>(),  new HashSet<>() );
