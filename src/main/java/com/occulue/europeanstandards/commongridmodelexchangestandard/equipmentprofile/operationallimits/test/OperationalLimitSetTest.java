...
public class OperationalLimitSetTest{
	 ...
	 */
	publics OperationalLimitSetTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateOperationalLimitSetCommand generateUpdateCommand() {
	        UpdateOperationalLimitSetCommand command = new UpdateOperationalLimitSetCommand( null,  new HashSet<>() );
