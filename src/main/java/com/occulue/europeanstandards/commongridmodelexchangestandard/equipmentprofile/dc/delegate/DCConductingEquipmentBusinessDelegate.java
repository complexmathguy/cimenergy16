 ...
 *   <li>Improving the available of DCConductingEquipment related services in the case of a
 *       DCConductingEquipment business related service failing.
 *   <li>Exposes a simpler, uniform DCConductingEquipment interface to the business tier, making it
 *       easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill DCConductingEquipment
 ...
 */
public class DCConductingEquipmentBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createDCConductingEquipment(
      CreateDCConductingEquipmentCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateDCConductingEquipmentCommand - by convention the future return value for a
      // create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateDCConductingEquipmentCommand of DCConductingEquipment is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateDCConductingEquipment(
      UpdateDCConductingEquipmentCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteDCConductingEquipmentCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete DCConductingEquipment using Id = "
              + command.getDCConductingEquipmentId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
  ...
  public DCConductingEquipment getDCConductingEquipment(
      DCConductingEquipmentFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<DCConductingEquipment> futureEntity =
          queryGateway.query(
              new FindDCConductingEquipmentQuery(
                  new LoadDCConductingEquipmentFilter(summary.getDCConductingEquipmentId())),
              ResponseTypes.instanceOf(DCConductingEquipment.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate DCConductingEquipment with id " + summary.getDCConductingEquipmentId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
   ...
   */
  public List<DCConductingEquipment> getAllDCConductingEquipment() throws ProcessingException {
    List<DCConductingEquipment> list = null;

    try {
      CompletableFuture<List<DCConductingEquipment>> futureList =
          queryGateway.query(
   ...
   */
  private DCConductingEquipment load(UUID id) throws ProcessingException {
    dCConductingEquipment =
        DCConductingEquipmentBusinessDelegate.getDCConductingEquipmentInstance()
            .getDCConductingEquipment(new DCConductingEquipmentFetchOneSummary(id));
    return dCConductingEquipment;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(DCConductingEquipmentBusinessDelegate.class.getName());
}
