...
public class StaticVarCompensatorTest{
	 ...
	 */
	publics StaticVarCompensatorTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateStaticVarCompensatorCommand generateNewCommand() {
        CreateStaticVarCompensatorCommand command = new CreateStaticVarCompensatorCommand( null,  SVCControlMode.values()[0] );
	...
	protected UpdateStaticVarCompensatorCommand generateUpdateCommand() {
	        UpdateStaticVarCompensatorCommand command = new UpdateStaticVarCompensatorCommand( null,  null,  null,  null,  SVCControlMode.values()[0],  null );
