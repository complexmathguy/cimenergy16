...
public class ACDCTerminalTest{
	 ...
	 */
	publics ACDCTerminalTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateACDCTerminalCommand generateNewCommand() {
        CreateACDCTerminalCommand command = new CreateACDCTerminalCommand( null );
	...
	protected UpdateACDCTerminalCommand generateUpdateCommand() {
	        UpdateACDCTerminalCommand command = new UpdateACDCTerminalCommand( null,  null,  new HashSet<>() );
