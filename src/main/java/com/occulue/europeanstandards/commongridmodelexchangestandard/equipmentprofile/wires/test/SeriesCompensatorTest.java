...
public class SeriesCompensatorTest{
	 ...
	 */
	publics SeriesCompensatorTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSeriesCompensatorCommand generateNewCommand() {
        CreateSeriesCompensatorCommand command = new CreateSeriesCompensatorCommand( null );
	...
	protected UpdateSeriesCompensatorCommand generateUpdateCommand() {
	        UpdateSeriesCompensatorCommand command = new UpdateSeriesCompensatorCommand( null,  null,  null,  null,  null,  null,  null,  null );
