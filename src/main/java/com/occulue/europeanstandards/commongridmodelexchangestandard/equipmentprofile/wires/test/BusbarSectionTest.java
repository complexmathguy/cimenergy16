...
public class BusbarSectionTest{
	 ...
	 */
	publics BusbarSectionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateBusbarSectionCommand generateNewCommand() {
        CreateBusbarSectionCommand command = new CreateBusbarSectionCommand( null );
	...
	protected UpdateBusbarSectionCommand generateUpdateCommand() {
	        UpdateBusbarSectionCommand command = new UpdateBusbarSectionCommand( null,  null );
