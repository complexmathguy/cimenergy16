...
public class VoltageLimitTest{
	 ...
	 */
	publics VoltageLimitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVoltageLimitCommand generateNewCommand() {
        CreateVoltageLimitCommand command = new CreateVoltageLimitCommand( null );
	...
	protected UpdateVoltageLimitCommand generateUpdateCommand() {
	        UpdateVoltageLimitCommand command = new UpdateVoltageLimitCommand( null,  null );
