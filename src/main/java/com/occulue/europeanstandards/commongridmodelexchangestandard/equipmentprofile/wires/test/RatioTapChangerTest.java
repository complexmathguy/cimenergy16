...
public class RatioTapChangerTest{
	 ...
	 */
	publics RatioTapChangerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateRatioTapChangerCommand generateNewCommand() {
        CreateRatioTapChangerCommand command = new CreateRatioTapChangerCommand( null,  TransformerControlMode.values()[0] );
	...
	protected UpdateRatioTapChangerCommand generateUpdateCommand() {
	        UpdateRatioTapChangerCommand command = new UpdateRatioTapChangerCommand( null,  null,  TransformerControlMode.values()[0],  null );
