 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.equivalents.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.equivalents.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.equivalents.subscriber.*;
...
public class EquivalentInjectionTest{
	 ...
	 */
	publics EquivalentInjectionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateEquivalentInjectionCommand generateNewCommand() {
        CreateEquivalentInjectionCommand command = new CreateEquivalentInjectionCommand( null );
	...
	protected UpdateEquivalentInjectionCommand generateUpdateCommand() {
	        UpdateEquivalentInjectionCommand command = new UpdateEquivalentInjectionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  new HashSet<>() );
