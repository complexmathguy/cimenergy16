...
public class EarthFaultCompensatorTest{
	 ...
	 */
	publics EarthFaultCompensatorTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateEarthFaultCompensatorCommand generateNewCommand() {
        CreateEarthFaultCompensatorCommand command = new CreateEarthFaultCompensatorCommand( null );
	...
	protected UpdateEarthFaultCompensatorCommand generateUpdateCommand() {
	        UpdateEarthFaultCompensatorCommand command = new UpdateEarthFaultCompensatorCommand( null,  null );
