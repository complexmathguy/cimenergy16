...
public class LinearShuntCompensatorTest{
	 ...
	 */
	publics LinearShuntCompensatorTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLinearShuntCompensatorCommand generateNewCommand() {
        CreateLinearShuntCompensatorCommand command = new CreateLinearShuntCompensatorCommand( null );
	...
	protected UpdateLinearShuntCompensatorCommand generateUpdateCommand() {
	        UpdateLinearShuntCompensatorCommand command = new UpdateLinearShuntCompensatorCommand( null,  null,  null,  null,  null );
