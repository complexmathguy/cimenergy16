...
public class ApparentPowerLimitTest{
	 ...
	 */
	publics ApparentPowerLimitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateApparentPowerLimitCommand generateNewCommand() {
        CreateApparentPowerLimitCommand command = new CreateApparentPowerLimitCommand( null );
	...
	protected UpdateApparentPowerLimitCommand generateUpdateCommand() {
	        UpdateApparentPowerLimitCommand command = new UpdateApparentPowerLimitCommand( null,  null );
