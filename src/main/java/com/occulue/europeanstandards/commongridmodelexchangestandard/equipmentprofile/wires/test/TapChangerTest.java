...
public class TapChangerTest{
	 ...
	 */
	publics TapChangerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTapChangerCommand generateNewCommand() {
        CreateTapChangerCommand command = new CreateTapChangerCommand( null );
	...
	protected UpdateTapChangerCommand generateUpdateCommand() {
	        UpdateTapChangerCommand command = new UpdateTapChangerCommand( null,  null,  null,  null,  null,  null,  null,  new HashSet<>() );
