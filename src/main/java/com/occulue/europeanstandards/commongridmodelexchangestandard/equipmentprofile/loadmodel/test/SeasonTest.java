...
public class SeasonTest{
	 ...
	 * @return		SeasonTest
	 */
	publics SeasonTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSeasonCommand generateNewCommand() {
        CreateSeasonCommand command = new CreateSeasonCommand( null );
	...
	protected UpdateSeasonCommand generateUpdateCommand() {
	        UpdateSeasonCommand command = new UpdateSeasonCommand( null,  null,  null );
