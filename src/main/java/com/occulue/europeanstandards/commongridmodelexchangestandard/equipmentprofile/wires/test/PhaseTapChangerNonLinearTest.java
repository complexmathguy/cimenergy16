...
public class PhaseTapChangerNonLinearTest{
	 ...
	 */
	publics PhaseTapChangerNonLinearTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePhaseTapChangerNonLinearCommand generateNewCommand() {
        CreatePhaseTapChangerNonLinearCommand command = new CreatePhaseTapChangerNonLinearCommand( null );
	...
	protected UpdatePhaseTapChangerNonLinearCommand generateUpdateCommand() {
	        UpdatePhaseTapChangerNonLinearCommand command = new UpdatePhaseTapChangerNonLinearCommand( null,  null,  null,  null );
