...
public class RegularIntervalScheduleTest{
	 ...
	 */
	publics RegularIntervalScheduleTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateRegularIntervalScheduleCommand generateNewCommand() {
        CreateRegularIntervalScheduleCommand command = new CreateRegularIntervalScheduleCommand( null );
	...
	protected UpdateRegularIntervalScheduleCommand generateUpdateCommand() {
	        UpdateRegularIntervalScheduleCommand command = new UpdateRegularIntervalScheduleCommand( null,  null,  null );
