...
public class ExternalNetworkInjectionTest{
	 ...
	 */
	publics ExternalNetworkInjectionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExternalNetworkInjectionCommand generateNewCommand() {
        CreateExternalNetworkInjectionCommand command = new CreateExternalNetworkInjectionCommand( null );
	...
	protected UpdateExternalNetworkInjectionCommand generateUpdateCommand() {
	        UpdateExternalNetworkInjectionCommand command = new UpdateExternalNetworkInjectionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
