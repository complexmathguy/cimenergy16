 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.topology.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.topology.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.topology.subscriber.*;
...
public class BusNameMarkerTest{
	 ...
	 */
	publics BusNameMarkerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateBusNameMarkerCommand generateNewCommand() {
        CreateBusNameMarkerCommand command = new CreateBusNameMarkerCommand( null );
	...
	protected UpdateBusNameMarkerCommand generateUpdateCommand() {
	        UpdateBusNameMarkerCommand command = new UpdateBusNameMarkerCommand( null,  null,  new HashSet<>() );
