...
public class CsConverterTest{
	 ...
	 */
	publics CsConverterTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCsConverterCommand generateNewCommand() {
        CreateCsConverterCommand command = new CreateCsConverterCommand( null );
	...
	protected UpdateCsConverterCommand generateUpdateCommand() {
	        UpdateCsConverterCommand command = new UpdateCsConverterCommand( null,  null,  null,  null,  null,  null,  null,  null );
