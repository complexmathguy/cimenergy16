...
public class TapChangerTablePointTest{
	 ...
	 */
	publics TapChangerTablePointTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTapChangerTablePointCommand generateNewCommand() {
        CreateTapChangerTablePointCommand command = new CreateTapChangerTablePointCommand( null );
	...
	protected UpdateTapChangerTablePointCommand generateUpdateCommand() {
	        UpdateTapChangerTablePointCommand command = new UpdateTapChangerTablePointCommand( null,  null,  null,  null,  null,  null,  null );
