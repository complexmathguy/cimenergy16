...
public class RegulatingControlTest{
	 ...
	 */
	publics RegulatingControlTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateRegulatingControlCommand generateNewCommand() {
        CreateRegulatingControlCommand command = new CreateRegulatingControlCommand( null,  RegulatingControlModeKind.values()[0] );
	...
	protected UpdateRegulatingControlCommand generateUpdateCommand() {
	        UpdateRegulatingControlCommand command = new UpdateRegulatingControlCommand( null,  RegulatingControlModeKind.values()[0],  null );
