...
public class AnalogValueTest{
	 ...
	 */
	publics AnalogValueTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAnalogValueCommand generateNewCommand() {
        CreateAnalogValueCommand command = new CreateAnalogValueCommand( null );
	...
	protected UpdateAnalogValueCommand generateUpdateCommand() {
	        UpdateAnalogValueCommand command = new UpdateAnalogValueCommand( null,  null,  new HashSet<>() );
