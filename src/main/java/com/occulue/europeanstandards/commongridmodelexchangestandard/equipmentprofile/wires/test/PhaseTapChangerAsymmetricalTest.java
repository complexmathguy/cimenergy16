...
public class PhaseTapChangerAsymmetricalTest{
	 ...
	 */
	publics PhaseTapChangerAsymmetricalTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePhaseTapChangerAsymmetricalCommand generateNewCommand() {
        CreatePhaseTapChangerAsymmetricalCommand command = new CreatePhaseTapChangerAsymmetricalCommand( null );
	...
	protected UpdatePhaseTapChangerAsymmetricalCommand generateUpdateCommand() {
	        UpdatePhaseTapChangerAsymmetricalCommand command = new UpdatePhaseTapChangerAsymmetricalCommand( null,  null );
