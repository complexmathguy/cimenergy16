...
public class GrossToNetActivePowerCurveTest{
	 ...
	 */
	publics GrossToNetActivePowerCurveTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateGrossToNetActivePowerCurveCommand generateUpdateCommand() {
	        UpdateGrossToNetActivePowerCurveCommand command = new UpdateGrossToNetActivePowerCurveCommand( null,  new HashSet<>() );
