...
public class AccumulatorLimitTest{
	 ...
	 */
	publics AccumulatorLimitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAccumulatorLimitCommand generateNewCommand() {
        CreateAccumulatorLimitCommand command = new CreateAccumulatorLimitCommand( null );
	...
	protected UpdateAccumulatorLimitCommand generateUpdateCommand() {
	        UpdateAccumulatorLimitCommand command = new UpdateAccumulatorLimitCommand( null,  null,  new HashSet<>() );
