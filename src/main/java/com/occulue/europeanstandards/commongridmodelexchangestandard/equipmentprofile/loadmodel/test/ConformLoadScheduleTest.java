...
public class ConformLoadScheduleTest{
	 ...
	 */
	publics ConformLoadScheduleTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateConformLoadScheduleCommand generateUpdateCommand() {
	        UpdateConformLoadScheduleCommand command = new UpdateConformLoadScheduleCommand( null,  new HashSet<>() );
