...
public class AccumulatorLimitSetTest{
	 ...
	 */
	publics AccumulatorLimitSetTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateAccumulatorLimitSetCommand generateUpdateCommand() {
	        UpdateAccumulatorLimitSetCommand command = new UpdateAccumulatorLimitSetCommand( null,  new HashSet<>() );
