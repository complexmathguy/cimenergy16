...
public class PhaseTapChangerTablePointTest{
	 ...
	 */
	publics PhaseTapChangerTablePointTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePhaseTapChangerTablePointCommand generateNewCommand() {
        CreatePhaseTapChangerTablePointCommand command = new CreatePhaseTapChangerTablePointCommand( null );
	...
	protected UpdatePhaseTapChangerTablePointCommand generateUpdateCommand() {
	        UpdatePhaseTapChangerTablePointCommand command = new UpdatePhaseTapChangerTablePointCommand( null,  null,  new HashSet<>() );
