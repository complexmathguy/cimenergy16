...
public class DCLineSegmentTest{
	 ...
	 */
	publics DCLineSegmentTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDCLineSegmentCommand generateNewCommand() {
        CreateDCLineSegmentCommand command = new CreateDCLineSegmentCommand( null );
	...
	protected UpdateDCLineSegmentCommand generateUpdateCommand() {
	        UpdateDCLineSegmentCommand command = new UpdateDCLineSegmentCommand( null,  null,  null,  null,  null,  new HashSet<>() );
