...
public class RotatingMachineTest{
	 ...
	 */
	publics RotatingMachineTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateRotatingMachineCommand generateNewCommand() {
        CreateRotatingMachineCommand command = new CreateRotatingMachineCommand( null );
	...
	protected UpdateRotatingMachineCommand generateUpdateCommand() {
	        UpdateRotatingMachineCommand command = new UpdateRotatingMachineCommand( null,  null,  null,  null,  new HashSet<>() );
