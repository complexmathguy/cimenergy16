...
public class EnergyConsumerTest{
	 ...
	 */
	publics EnergyConsumerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateEnergyConsumerCommand generateNewCommand() {
        CreateEnergyConsumerCommand command = new CreateEnergyConsumerCommand( null );
	...
	protected UpdateEnergyConsumerCommand generateUpdateCommand() {
	        UpdateEnergyConsumerCommand command = new UpdateEnergyConsumerCommand( null,  null,  null,  null,  null,  new HashSet<>() );
