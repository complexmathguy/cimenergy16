 ...
 *   <li>Improving the available of ReactiveCapabilityCurve related services in the case of a
 *       ReactiveCapabilityCurve business related service failing.
 *   <li>Exposes a simpler, uniform ReactiveCapabilityCurve interface to the business tier, making
 *       it easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill ReactiveCapabilityCurve
 ...
 */
public class ReactiveCapabilityCurveBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createReactiveCapabilityCurve(
      CreateReactiveCapabilityCurveCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateReactiveCapabilityCurveCommand - by convention the future return value for
      // a create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateReactiveCapabilityCurveCommand of ReactiveCapabilityCurve is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateReactiveCapabilityCurve(
      UpdateReactiveCapabilityCurveCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteReactiveCapabilityCurveCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete ReactiveCapabilityCurve using Id = "
              + command.getReactiveCapabilityCurveId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
  ...
  public ReactiveCapabilityCurve getReactiveCapabilityCurve(
      ReactiveCapabilityCurveFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "ReactiveCapabilityCurveFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<ReactiveCapabilityCurve> futureEntity =
          queryGateway.query(
              new FindReactiveCapabilityCurveQuery(
                  new LoadReactiveCapabilityCurveFilter(summary.getReactiveCapabilityCurveId())),
              ResponseTypes.instanceOf(ReactiveCapabilityCurve.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate ReactiveCapabilityCurve with id "
   ...
   */
  public List<ReactiveCapabilityCurve> getAllReactiveCapabilityCurve() throws ProcessingException {
    List<ReactiveCapabilityCurve> list = null;

    try {
      CompletableFuture<List<ReactiveCapabilityCurve>> futureList =
          queryGateway.query(
   ...
   */
  private ReactiveCapabilityCurve load(UUID id) throws ProcessingException {
    reactiveCapabilityCurve =
        ReactiveCapabilityCurveBusinessDelegate.getReactiveCapabilityCurveInstance()
            .getReactiveCapabilityCurve(new ReactiveCapabilityCurveFetchOneSummary(id));
    return reactiveCapabilityCurve;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(ReactiveCapabilityCurveBusinessDelegate.class.getName());
}
