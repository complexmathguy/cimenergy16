...
public class PetersenCoilTest{
	 ...
	 */
	publics PetersenCoilTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePetersenCoilCommand generateNewCommand() {
        CreatePetersenCoilCommand command = new CreatePetersenCoilCommand( null,  PetersenCoilModeKind.values()[0] );
	...
	protected UpdatePetersenCoilCommand generateUpdateCommand() {
	        UpdatePetersenCoilCommand command = new UpdatePetersenCoilCommand( null,  PetersenCoilModeKind.values()[0],  null,  null,  null,  null,  null,  null );
