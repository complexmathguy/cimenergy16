...
public class PowerTransformerEndTest{
	 ...
	 */
	publics PowerTransformerEndTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePowerTransformerEndCommand generateNewCommand() {
        CreatePowerTransformerEndCommand command = new CreatePowerTransformerEndCommand( null,  WindingConnection.values()[0] );
	...
	protected UpdatePowerTransformerEndCommand generateUpdateCommand() {
	        UpdatePowerTransformerEndCommand command = new UpdatePowerTransformerEndCommand( null,  null,  null,  WindingConnection.values()[0],  null,  null,  null,  null,  null,  null,  null,  null,  null,  new HashSet<>() );
