...
public class MutualCouplingTest{
	 ...
	 */
	publics MutualCouplingTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateMutualCouplingCommand generateNewCommand() {
        CreateMutualCouplingCommand command = new CreateMutualCouplingCommand( null );
	...
	protected UpdateMutualCouplingCommand generateUpdateCommand() {
	        UpdateMutualCouplingCommand command = new UpdateMutualCouplingCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  new HashSet<>(),  new HashSet<>() );
