 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.wires.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.wires.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.wires.subscriber.*;
...
public class SynchronousMachineTest{
	 ...
	 */
	publics SynchronousMachineTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSynchronousMachineCommand generateNewCommand() {
        CreateSynchronousMachineCommand command = new CreateSynchronousMachineCommand( null,  ShortCircuitRotorKind.values()[0],  SynchronousMachineKind.values()[0] );
	...
	protected UpdateSynchronousMachineCommand generateUpdateCommand() {
	        UpdateSynchronousMachineCommand command = new UpdateSynchronousMachineCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  ShortCircuitRotorKind.values()[0],  SynchronousMachineKind.values()[0],  null,  null,  null,  new HashSet<>() );
