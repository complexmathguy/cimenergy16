...
public class PhaseTapChangerTabularTest{
	 ...
	 */
	publics PhaseTapChangerTabularTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdatePhaseTapChangerTabularCommand generateUpdateCommand() {
	        UpdatePhaseTapChangerTabularCommand command = new UpdatePhaseTapChangerTabularCommand( null,  new HashSet<>() );
