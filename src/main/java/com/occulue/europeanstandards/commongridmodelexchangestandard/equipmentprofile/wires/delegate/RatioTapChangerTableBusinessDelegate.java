 ...
 *   <li>Improving the available of RatioTapChangerTable related services in the case of a
 *       RatioTapChangerTable business related service failing.
 *   <li>Exposes a simpler, uniform RatioTapChangerTable interface to the business tier, making it
 *       easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill RatioTapChangerTable
 ...
 */
public class RatioTapChangerTableBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createRatioTapChangerTable(
      CreateRatioTapChangerTableCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateRatioTapChangerTableCommand - by convention the future return value for a
      // create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateRatioTapChangerTableCommand of RatioTapChangerTable is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateRatioTapChangerTable(
      UpdateRatioTapChangerTableCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteRatioTapChangerTableCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete RatioTapChangerTable using Id = " + command.getRatioTapChangerTableId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
  ...
  public RatioTapChangerTable getRatioTapChangerTable(RatioTapChangerTableFetchOneSummary summary)
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<RatioTapChangerTable> futureEntity =
          queryGateway.query(
              new FindRatioTapChangerTableQuery(
                  new LoadRatioTapChangerTableFilter(summary.getRatioTapChangerTableId())),
              ResponseTypes.instanceOf(RatioTapChangerTable.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate RatioTapChangerTable with id " + summary.getRatioTapChangerTableId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
   ...
   */
  public List<RatioTapChangerTable> getAllRatioTapChangerTable() throws ProcessingException {
    List<RatioTapChangerTable> list = null;

    try {
      CompletableFuture<List<RatioTapChangerTable>> futureList =
          queryGateway.query(
   ...
   */
  private RatioTapChangerTable load(UUID id) throws ProcessingException {
    ratioTapChangerTable =
        RatioTapChangerTableBusinessDelegate.getRatioTapChangerTableInstance()
            .getRatioTapChangerTable(new RatioTapChangerTableFetchOneSummary(id));
    return ratioTapChangerTable;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(RatioTapChangerTableBusinessDelegate.class.getName());
}
