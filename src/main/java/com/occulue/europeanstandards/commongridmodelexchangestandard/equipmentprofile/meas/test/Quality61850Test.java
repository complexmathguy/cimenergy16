...
public class Quality61850Test{
	 ...
	 */
	publics Quality61850Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateQuality61850Command generateNewCommand() {
        CreateQuality61850Command command = new CreateQuality61850Command( null,  Source.values()[0],  Validity.values()[0] );
	...
	protected UpdateQuality61850Command generateUpdateCommand() {
	        UpdateQuality61850Command command = new UpdateQuality61850Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  Source.values()[0],  null,  null,  Validity.values()[0] );
