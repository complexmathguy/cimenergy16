...
public class DCGroundTest{
	 ...
	 * @return		DCGroundTest
	 */
	publics DCGroundTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDCGroundCommand generateNewCommand() {
        CreateDCGroundCommand command = new CreateDCGroundCommand( null );
	...
	protected UpdateDCGroundCommand generateUpdateCommand() {
	        UpdateDCGroundCommand command = new UpdateDCGroundCommand( null,  null,  null );
