...
public class SetPointTest{
	 ...
	 * @return		SetPointTest
	 */
	publics SetPointTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSetPointCommand generateNewCommand() {
        CreateSetPointCommand command = new CreateSetPointCommand( null );
	...
	protected UpdateSetPointCommand generateUpdateCommand() {
	        UpdateSetPointCommand command = new UpdateSetPointCommand( null,  null,  null );
