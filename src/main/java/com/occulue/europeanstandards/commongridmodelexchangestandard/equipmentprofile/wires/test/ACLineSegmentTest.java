...
public class ACLineSegmentTest{
	 ...
	 */
	publics ACLineSegmentTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateACLineSegmentCommand generateNewCommand() {
        CreateACLineSegmentCommand command = new CreateACLineSegmentCommand( null );
	...
	protected UpdateACLineSegmentCommand generateUpdateCommand() {
	        UpdateACLineSegmentCommand command = new UpdateACLineSegmentCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
