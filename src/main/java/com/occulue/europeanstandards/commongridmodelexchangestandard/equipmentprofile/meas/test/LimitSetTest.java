...
public class LimitSetTest{
	 ...
	 * @return		LimitSetTest
	 */
	publics LimitSetTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLimitSetCommand generateNewCommand() {
        CreateLimitSetCommand command = new CreateLimitSetCommand( null );
	...
	protected UpdateLimitSetCommand generateUpdateCommand() {
	        UpdateLimitSetCommand command = new UpdateLimitSetCommand( null,  null );
