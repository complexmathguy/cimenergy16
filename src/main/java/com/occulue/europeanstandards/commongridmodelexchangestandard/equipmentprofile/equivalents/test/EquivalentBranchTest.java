...
public class EquivalentBranchTest{
	 ...
	 */
	publics EquivalentBranchTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateEquivalentBranchCommand generateNewCommand() {
        CreateEquivalentBranchCommand command = new CreateEquivalentBranchCommand( null );
	...
	protected UpdateEquivalentBranchCommand generateUpdateCommand() {
	        UpdateEquivalentBranchCommand command = new UpdateEquivalentBranchCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
