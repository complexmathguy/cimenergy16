 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.operationallimits.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.operationallimits.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.operationallimits.subscriber.*;
...
public class OperationalLimitTypeTest{
	 ...
	 */
	publics OperationalLimitTypeTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateOperationalLimitTypeCommand generateNewCommand() {
        CreateOperationalLimitTypeCommand command = new CreateOperationalLimitTypeCommand( null,  OperationalLimitDirectionKind.values()[0],  LimitTypeEnum.values()[0] );
	...
	protected UpdateOperationalLimitTypeCommand generateUpdateCommand() {
	        UpdateOperationalLimitTypeCommand command = new UpdateOperationalLimitTypeCommand( null,  null,  OperationalLimitDirectionKind.values()[0],  LimitTypeEnum.values()[0] );
