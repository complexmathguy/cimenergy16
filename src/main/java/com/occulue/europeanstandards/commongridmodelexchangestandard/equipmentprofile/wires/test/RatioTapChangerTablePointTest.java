...
public class RatioTapChangerTablePointTest{
	 ...
	 */
	publics RatioTapChangerTablePointTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateRatioTapChangerTablePointCommand generateUpdateCommand() {
	        UpdateRatioTapChangerTablePointCommand command = new UpdateRatioTapChangerTablePointCommand( null,  new HashSet<>() );
