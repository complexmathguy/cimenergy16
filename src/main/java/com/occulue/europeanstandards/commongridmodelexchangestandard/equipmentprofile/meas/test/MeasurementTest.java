 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.meas.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.meas.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.meas.subscriber.*;
...
public class MeasurementTest{
	 ...
	 */
	publics MeasurementTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateMeasurementCommand generateNewCommand() {
        CreateMeasurementCommand command = new CreateMeasurementCommand( null,  PhaseCode.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateMeasurementCommand generateUpdateCommand() {
	        UpdateMeasurementCommand command = new UpdateMeasurementCommand( null,  null,  PhaseCode.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  new HashSet<>() );
