...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.loadmodel.validator.*;
 ...
 *   <li>Improving the available of LoadGroup related services in the case of a LoadGroup business
 *       related service failing.
 *   <li>Exposes a simpler, uniform LoadGroup interface to the business tier, making it easy for
 *       clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill LoadGroup business related
 *       services.
 * </ol>
 *
 * <p>
 ...
 */
public class LoadGroupBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
  ...
  public CompletableFuture<UUID> createLoadGroup(CreateLoadGroupCommand command)
    ...
    try {
      ...
      // --------------------------------------
      if (command.getLoadGroupId() == null) command.setLoadGroupId(UUID.randomUUID());
      ...
      // ---------------------------------------
      // issue the CreateLoadGroupCommand - by convention the future return value for a create
      // command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateLoadGroupCommand of LoadGroup is " + command);
  ...
  public LoadGroup getLoadGroup(LoadGroupFetchOneSummary summary)
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<LoadGroup> futureEntity =
          queryGateway.query(
              new FindLoadGroupQuery(new LoadLoadGroupFilter(summary.getLoadGroupId())),
   ...
   */
  public List<LoadGroup> getAllLoadGroup() throws ProcessingException {
    List<LoadGroup> list = null;

    try {
      CompletableFuture<List<LoadGroup>> futureList =
          queryGateway.query(
              new FindAllLoadGroupQuery(), ResponseTypes.multipleInstancesOf(LoadGroup.class));
  ...
  /**
   * add LoadGroup to LoadGroups
   *
   * @param command AssignLoadGroupsToLoadGroupCommand
   * @exception ProcessingException
   */
  public void addToLoadGroups(AssignLoadGroupsToLoadGroupCommand command)
      throws ProcessingException {

    // -------------------------------------------
    // load the parent
    // -------------------------------------------
    load(command.getLoadGroupId());

    com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.loadmodel
            .delegate.LoadGroupBusinessDelegate
        childDelegate =
            com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.loadmodel
                .delegate.LoadGroupBusinessDelegate.getLoadGroupInstance();
    LoadGroupBusinessDelegate parentDelegate = LoadGroupBusinessDelegate.getLoadGroupInstance();
    UUID childId = command.getAddTo().getLoadGroupId();
    ...
    try {
      ...
      final String msg = "Failed to add a LoadGroup as LoadGroups to LoadGroup";
  ...
  /**
   * remove LoadGroup from LoadGroups
   *
   * @param command RemoveLoadGroupsFromLoadGroupCommand
   * @exception ProcessingException
   */
  public void removeFromLoadGroups(RemoveLoadGroupsFromLoadGroupCommand command)
      throws ProcessingException {
    ...
    com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.loadmodel
        ...
        childDelegate =
            com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentprofile.loadmodel
                .delegate.LoadGroupBusinessDelegate.getLoadGroupInstance();
    UUID childId = command.getRemoveFrom().getLoadGroupId();
   ...
   * @return LoadGroup
   */
  private LoadGroup load(UUID id) throws ProcessingException {
    loadGroup =
        LoadGroupBusinessDelegate.getLoadGroupInstance()
            .getLoadGroup(new LoadGroupFetchOneSummary(id));
    return loadGroup;
  }
