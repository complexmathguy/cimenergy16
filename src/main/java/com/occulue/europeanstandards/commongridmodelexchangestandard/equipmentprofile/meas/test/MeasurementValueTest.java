...
public class MeasurementValueTest{
	 ...
	 */
	publics MeasurementValueTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateMeasurementValueCommand generateNewCommand() {
        CreateMeasurementValueCommand command = new CreateMeasurementValueCommand( null );
	...
	protected UpdateMeasurementValueCommand generateUpdateCommand() {
	        UpdateMeasurementValueCommand command = new UpdateMeasurementValueCommand( null,  null,  null,  new HashSet<>() );
