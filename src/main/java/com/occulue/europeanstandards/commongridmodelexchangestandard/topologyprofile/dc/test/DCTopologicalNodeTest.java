 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.topologyprofile.dc.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.topologyprofile.dc.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.topologyprofile.dc.subscriber.*;
...
public class DCTopologicalNodeTest{
	 ...
	 */
	publics DCTopologicalNodeTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateDCTopologicalNodeCommand generateUpdateCommand() {
	        UpdateDCTopologicalNodeCommand command = new UpdateDCTopologicalNodeCommand( null,  new HashSet<>() );
