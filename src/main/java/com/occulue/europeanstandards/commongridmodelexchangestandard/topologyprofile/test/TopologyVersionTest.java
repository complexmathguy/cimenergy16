 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.topologyprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.topologyprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.topologyprofile.subscriber.*;
...
public class TopologyVersionTest{
	 ...
	 */
	publics TopologyVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTopologyVersionCommand generateNewCommand() {
        CreateTopologyVersionCommand command = new CreateTopologyVersionCommand( null );
	...
	protected UpdateTopologyVersionCommand generateUpdateCommand() {
	        UpdateTopologyVersionCommand command = new UpdateTopologyVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
