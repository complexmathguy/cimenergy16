...
public class ExcSEXSTest{
	 ...
	 * @return		ExcSEXSTest
	 */
	publics ExcSEXSTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcSEXSCommand generateNewCommand() {
        CreateExcSEXSCommand command = new CreateExcSEXSCommand( null );
	...
	protected UpdateExcSEXSCommand generateUpdateCommand() {
	        UpdateExcSEXSCommand command = new UpdateExcSEXSCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
