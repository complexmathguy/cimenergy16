...
public class DiscExcContIEEEDEC2ATest{
	 ...
	 */
	publics DiscExcContIEEEDEC2ATest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDiscExcContIEEEDEC2ACommand generateNewCommand() {
        CreateDiscExcContIEEEDEC2ACommand command = new CreateDiscExcContIEEEDEC2ACommand( null );
	...
	protected UpdateDiscExcContIEEEDEC2ACommand generateUpdateCommand() {
	        UpdateDiscExcContIEEEDEC2ACommand command = new UpdateDiscExcContIEEEDEC2ACommand( null,  null,  null,  null,  null,  null );
