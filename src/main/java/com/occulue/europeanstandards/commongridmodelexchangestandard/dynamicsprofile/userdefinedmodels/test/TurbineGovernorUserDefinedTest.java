...
public class TurbineGovernorUserDefinedTest{
	 ...
	 */
	publics TurbineGovernorUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTurbineGovernorUserDefinedCommand generateNewCommand() {
        CreateTurbineGovernorUserDefinedCommand command = new CreateTurbineGovernorUserDefinedCommand( null );
	...
	protected UpdateTurbineGovernorUserDefinedCommand generateUpdateCommand() {
	        UpdateTurbineGovernorUserDefinedCommand command = new UpdateTurbineGovernorUserDefinedCommand( null,  null );
