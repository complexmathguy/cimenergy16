...
public class PowerSystemStabilizerDynamicsTest{
	 ...
	 */
	publics PowerSystemStabilizerDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdatePowerSystemStabilizerDynamicsCommand generateUpdateCommand() {
	        UpdatePowerSystemStabilizerDynamicsCommand command = new UpdatePowerSystemStabilizerDynamicsCommand( null,  null );
