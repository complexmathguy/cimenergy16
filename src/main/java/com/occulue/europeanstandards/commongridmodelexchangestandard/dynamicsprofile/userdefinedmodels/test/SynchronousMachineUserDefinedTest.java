...
public class SynchronousMachineUserDefinedTest{
	 ...
	 */
	publics SynchronousMachineUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSynchronousMachineUserDefinedCommand generateNewCommand() {
        CreateSynchronousMachineUserDefinedCommand command = new CreateSynchronousMachineUserDefinedCommand( null );
	...
	protected UpdateSynchronousMachineUserDefinedCommand generateUpdateCommand() {
	        UpdateSynchronousMachineUserDefinedCommand command = new UpdateSynchronousMachineUserDefinedCommand( null,  null );
