...
public class UnderexcLimX1Test{
	 ...
	 */
	publics UnderexcLimX1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateUnderexcLimX1Command generateNewCommand() {
        CreateUnderexcLimX1Command command = new CreateUnderexcLimX1Command( null );
	...
	protected UpdateUnderexcLimX1Command generateUpdateCommand() {
	        UpdateUnderexcLimX1Command command = new UpdateUnderexcLimX1Command( null,  null,  null,  null,  null,  null,  null );
