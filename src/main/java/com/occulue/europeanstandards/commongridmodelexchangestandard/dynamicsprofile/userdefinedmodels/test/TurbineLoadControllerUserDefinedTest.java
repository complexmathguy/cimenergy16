...
public class TurbineLoadControllerUserDefinedTest{
	 ...
	 */
	publics TurbineLoadControllerUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTurbineLoadControllerUserDefinedCommand generateNewCommand() {
        CreateTurbineLoadControllerUserDefinedCommand command = new CreateTurbineLoadControllerUserDefinedCommand( null );
	...
	protected UpdateTurbineLoadControllerUserDefinedCommand generateUpdateCommand() {
	        UpdateTurbineLoadControllerUserDefinedCommand command = new UpdateTurbineLoadControllerUserDefinedCommand( null,  null );
