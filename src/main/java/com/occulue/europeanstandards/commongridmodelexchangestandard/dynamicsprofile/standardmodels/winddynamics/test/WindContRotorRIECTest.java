...
public class WindContRotorRIECTest{
	 ...
	 */
	publics WindContRotorRIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindContRotorRIECCommand generateNewCommand() {
        CreateWindContRotorRIECCommand command = new CreateWindContRotorRIECCommand( null );
	...
	protected UpdateWindContRotorRIECCommand generateUpdateCommand() {
	        UpdateWindContRotorRIECCommand command = new UpdateWindContRotorRIECCommand( null,  null,  null,  null,  null,  null,  null,  null,  null );
