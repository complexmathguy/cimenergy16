 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.turbineloadcontrollerdynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.turbineloadcontrollerdynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.turbineloadcontrollerdynamics.subscriber.*;
...
public class TurbLCFB1Test{
	 ...
	 */
	publics TurbLCFB1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTurbLCFB1Command generateNewCommand() {
        CreateTurbLCFB1Command command = new CreateTurbLCFB1Command( null );
	...
	protected UpdateTurbLCFB1Command generateUpdateCommand() {
	        UpdateTurbLCFB1Command command = new UpdateTurbLCFB1Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
