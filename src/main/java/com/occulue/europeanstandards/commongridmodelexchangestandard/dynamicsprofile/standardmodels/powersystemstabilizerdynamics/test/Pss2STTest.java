...
public class Pss2STTest{
	 ...
	 * @return		Pss2STTest
	 */
	publics Pss2STTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePss2STCommand generateNewCommand() {
        CreatePss2STCommand command = new CreatePss2STCommand( null,  InputSignalKind.values()[0],  InputSignalKind.values()[0] );
	...
	protected UpdatePss2STCommand generateUpdateCommand() {
	        UpdatePss2STCommand command = new UpdatePss2STCommand( null,  InputSignalKind.values()[0],  InputSignalKind.values()[0],  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
