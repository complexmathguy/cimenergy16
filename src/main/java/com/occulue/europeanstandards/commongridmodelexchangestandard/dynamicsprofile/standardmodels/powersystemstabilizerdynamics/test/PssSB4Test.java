...
public class PssSB4Test{
	 ...
	 * @return		PssSB4Test
	 */
	publics PssSB4Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePssSB4Command generateNewCommand() {
        CreatePssSB4Command command = new CreatePssSB4Command( null );
	...
	protected UpdatePssSB4Command generateUpdateCommand() {
	        UpdatePssSB4Command command = new UpdatePssSB4Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
