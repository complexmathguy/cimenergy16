...
public class PFVArControllerType2DynamicsTest{
	 ...
	 */
	publics PFVArControllerType2DynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdatePFVArControllerType2DynamicsCommand generateUpdateCommand() {
	        UpdatePFVArControllerType2DynamicsCommand command = new UpdatePFVArControllerType2DynamicsCommand( null,  null );
