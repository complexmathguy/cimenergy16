...
public class PssPTIST1Test{
	 ...
	 */
	publics PssPTIST1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePssPTIST1Command generateNewCommand() {
        CreatePssPTIST1Command command = new CreatePssPTIST1Command( null );
	...
	protected UpdatePssPTIST1Command generateUpdateCommand() {
	        UpdatePssPTIST1Command command = new UpdatePssPTIST1Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
