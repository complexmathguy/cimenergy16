...
public class LoadCompositeTest{
	 ...
	 */
	publics LoadCompositeTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLoadCompositeCommand generateNewCommand() {
        CreateLoadCompositeCommand command = new CreateLoadCompositeCommand( null );
	...
	protected UpdateLoadCompositeCommand generateUpdateCommand() {
	        UpdateLoadCompositeCommand command = new UpdateLoadCompositeCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
