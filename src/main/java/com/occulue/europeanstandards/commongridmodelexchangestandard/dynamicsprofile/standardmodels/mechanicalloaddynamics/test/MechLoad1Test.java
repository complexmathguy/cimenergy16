 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.mechanicalloaddynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.mechanicalloaddynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.mechanicalloaddynamics.subscriber.*;
...
public class MechLoad1Test{
	 ...
	 */
	publics MechLoad1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateMechLoad1Command generateNewCommand() {
        CreateMechLoad1Command command = new CreateMechLoad1Command( null );
	...
	protected UpdateMechLoad1Command generateUpdateCommand() {
	        UpdateMechLoad1Command command = new UpdateMechLoad1Command( null,  null,  null,  null,  null );
