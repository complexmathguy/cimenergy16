 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.subscriber.*;
...
public class DynamicsVersionTest{
	 ...
	 */
	publics DynamicsVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDynamicsVersionCommand generateNewCommand() {
        CreateDynamicsVersionCommand command = new CreateDynamicsVersionCommand( null );
	...
	protected UpdateDynamicsVersionCommand generateUpdateCommand() {
	        UpdateDynamicsVersionCommand command = new UpdateDynamicsVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
