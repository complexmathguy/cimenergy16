 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardinterconnections.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardinterconnections.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardinterconnections.subscriber.*;
...
public class RemoteInputSignalTest{
	 ...
	 */
	publics RemoteInputSignalTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateRemoteInputSignalCommand generateNewCommand() {
        CreateRemoteInputSignalCommand command = new CreateRemoteInputSignalCommand( null,  RemoteSignalKind.values()[0] );
	...
	protected UpdateRemoteInputSignalCommand generateUpdateCommand() {
	        UpdateRemoteInputSignalCommand command = new UpdateRemoteInputSignalCommand( null,  RemoteSignalKind.values()[0],  new HashSet<>() );
