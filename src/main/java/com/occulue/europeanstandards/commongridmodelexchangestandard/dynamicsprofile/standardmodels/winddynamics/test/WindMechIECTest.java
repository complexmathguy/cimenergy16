...
public class WindMechIECTest{
	 ...
	 */
	publics WindMechIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindMechIECCommand generateNewCommand() {
        CreateWindMechIECCommand command = new CreateWindMechIECCommand( null );
	...
	protected UpdateWindMechIECCommand generateUpdateCommand() {
	        UpdateWindMechIECCommand command = new UpdateWindMechIECCommand( null,  null,  null,  null,  null );
