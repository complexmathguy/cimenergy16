...
public class WindTurbineType3or4DynamicsTest{
	 ...
	 */
	publics WindTurbineType3or4DynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateWindTurbineType3or4DynamicsCommand generateUpdateCommand() {
	        UpdateWindTurbineType3or4DynamicsCommand command = new UpdateWindTurbineType3or4DynamicsCommand( null,  null );
