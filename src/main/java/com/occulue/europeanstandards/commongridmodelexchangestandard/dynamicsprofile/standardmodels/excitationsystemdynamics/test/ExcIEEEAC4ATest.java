...
public class ExcIEEEAC4ATest{
	 ...
	 */
	publics ExcIEEEAC4ATest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcIEEEAC4ACommand generateNewCommand() {
        CreateExcIEEEAC4ACommand command = new CreateExcIEEEAC4ACommand( null );
	...
	protected UpdateExcIEEEAC4ACommand generateUpdateCommand() {
	        UpdateExcIEEEAC4ACommand command = new UpdateExcIEEEAC4ACommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
