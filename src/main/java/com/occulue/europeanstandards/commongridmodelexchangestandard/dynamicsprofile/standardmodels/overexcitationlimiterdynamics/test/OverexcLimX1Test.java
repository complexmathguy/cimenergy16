...
public class OverexcLimX1Test{
	 ...
	 */
	publics OverexcLimX1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateOverexcLimX1Command generateNewCommand() {
        CreateOverexcLimX1Command command = new CreateOverexcLimX1Command( null );
	...
	protected UpdateOverexcLimX1Command generateUpdateCommand() {
	        UpdateOverexcLimX1Command command = new UpdateOverexcLimX1Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
