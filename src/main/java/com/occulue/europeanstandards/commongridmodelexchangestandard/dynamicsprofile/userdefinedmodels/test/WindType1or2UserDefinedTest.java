...
public class WindType1or2UserDefinedTest{
	 ...
	 */
	publics WindType1or2UserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindType1or2UserDefinedCommand generateNewCommand() {
        CreateWindType1or2UserDefinedCommand command = new CreateWindType1or2UserDefinedCommand( null );
	...
	protected UpdateWindType1or2UserDefinedCommand generateUpdateCommand() {
	        UpdateWindType1or2UserDefinedCommand command = new UpdateWindType1or2UserDefinedCommand( null,  null );
