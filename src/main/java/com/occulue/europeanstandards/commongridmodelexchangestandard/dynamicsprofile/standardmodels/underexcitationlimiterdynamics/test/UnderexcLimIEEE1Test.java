...
public class UnderexcLimIEEE1Test{
	 ...
	 */
	publics UnderexcLimIEEE1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateUnderexcLimIEEE1Command generateNewCommand() {
        CreateUnderexcLimIEEE1Command command = new CreateUnderexcLimIEEE1Command( null );
	...
	protected UpdateUnderexcLimIEEE1Command generateUpdateCommand() {
	        UpdateUnderexcLimIEEE1Command command = new UpdateUnderexcLimIEEE1Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
