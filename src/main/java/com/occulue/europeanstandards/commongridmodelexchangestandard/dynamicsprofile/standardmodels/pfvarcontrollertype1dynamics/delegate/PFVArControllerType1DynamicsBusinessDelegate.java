...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.pfvarcontrollertype1dynamics.validator.*;
 ...
 *   <li>Improving the available of PFVArControllerType1Dynamics related services in the case of a
 *       PFVArControllerType1Dynamics business related service failing.
 *   <li>Exposes a simpler, uniform PFVArControllerType1Dynamics interface to the business tier,
 ...
 *       PFVArControllerType1Dynamics business related services.
 * </ol>
 *
 * <p>
 *
 ...
 */
public class PFVArControllerType1DynamicsBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public static PFVArControllerType1DynamicsBusinessDelegate
      getPFVArControllerType1DynamicsInstance() {
   ...
   */
  public CompletableFuture<UUID> createPFVArControllerType1Dynamics(
      CreatePFVArControllerType1DynamicsCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreatePFVArControllerType1DynamicsCommand - by convention the future return value
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreatePFVArControllerType1DynamicsCommand of PFVArControllerType1Dynamics is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updatePFVArControllerType1Dynamics(
      UpdatePFVArControllerType1DynamicsCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeletePFVArControllerType1DynamicsCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete PFVArControllerType1Dynamics using Id = "
  ...
  /**
   * Method to retrieve the PFVArControllerType1Dynamics via
   * PFVArControllerType1DynamicsFetchOneSummary
   *
  ...
  public PFVArControllerType1Dynamics getPFVArControllerType1Dynamics(
      PFVArControllerType1DynamicsFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "PFVArControllerType1DynamicsFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<PFVArControllerType1Dynamics> futureEntity =
          queryGateway.query(
              new FindPFVArControllerType1DynamicsQuery(
                  new LoadPFVArControllerType1DynamicsFilter(
      ...
      final String errMsg =
          "Unable to locate PFVArControllerType1Dynamics with id "
              + summary.getPFVArControllerType1DynamicsId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
  ...
  public List<PFVArControllerType1Dynamics> getAllPFVArControllerType1Dynamics()
    ...
    try {
      CompletableFuture<List<PFVArControllerType1Dynamics>> futureList =
          queryGateway.query(
  ...
  /**
   * assign PFVArControllerType1Dynamics on PFVArControllerType1Dynamics
   *
  ...
  public void assignPFVArControllerType1Dynamics(
    ...
    // load the parent
    // --------------------------------------------
    load(command.getPFVArControllerType1DynamicsId());

    com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels
            .pfvarcontrollertype1dynamics.delegate.PFVArControllerType1DynamicsBusinessDelegate
        childDelegate =
            com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile
                .standardmodels.pfvarcontrollertype1dynamics.delegate
                .PFVArControllerType1DynamicsBusinessDelegate
                .getPFVArControllerType1DynamicsInstance();
    PFVArControllerType1DynamicsBusinessDelegate parentDelegate =
  ...
  public void unAssignPFVArControllerType1Dynamics(
    ...
    try {
      ...
      final String msg =
          "Failed to unassign PFVArControllerType1Dynamics on PFVArControllerType1Dynamics";
   ...
   */
  private PFVArControllerType1Dynamics load(UUID id) throws ProcessingException {
    pFVArControllerType1Dynamics =
        PFVArControllerType1DynamicsBusinessDelegate.getPFVArControllerType1DynamicsInstance()
            .getPFVArControllerType1Dynamics(new PFVArControllerType1DynamicsFetchOneSummary(id));
    return pFVArControllerType1Dynamics;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArControllerType1DynamicsBusinessDelegate.class.getName());
}
