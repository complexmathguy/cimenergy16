...
public class WindGenTurbineType3bIECTest{
	 ...
	 */
	publics WindGenTurbineType3bIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindGenTurbineType3bIECCommand generateNewCommand() {
        CreateWindGenTurbineType3bIECCommand command = new CreateWindGenTurbineType3bIECCommand( null );
	...
	protected UpdateWindGenTurbineType3bIECCommand generateUpdateCommand() {
	        UpdateWindGenTurbineType3bIECCommand command = new UpdateWindGenTurbineType3bIECCommand( null,  null,  null,  null,  null,  null );
