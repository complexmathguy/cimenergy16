...
public class VCompIEEEType1Test{
	 ...
	 */
	publics VCompIEEEType1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVCompIEEEType1Command generateNewCommand() {
        CreateVCompIEEEType1Command command = new CreateVCompIEEEType1Command( null );
	...
	protected UpdateVCompIEEEType1Command generateUpdateCommand() {
	        UpdateVCompIEEEType1Command command = new UpdateVCompIEEEType1Command( null,  null,  null,  null );
