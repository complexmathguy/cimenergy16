...
public class ExcIEEEAC5ATest{
	 ...
	 */
	publics ExcIEEEAC5ATest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcIEEEAC5ACommand generateNewCommand() {
        CreateExcIEEEAC5ACommand command = new CreateExcIEEEAC5ACommand( null );
	...
	protected UpdateExcIEEEAC5ACommand generateUpdateCommand() {
	        UpdateExcIEEEAC5ACommand command = new UpdateExcIEEEAC5ACommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
