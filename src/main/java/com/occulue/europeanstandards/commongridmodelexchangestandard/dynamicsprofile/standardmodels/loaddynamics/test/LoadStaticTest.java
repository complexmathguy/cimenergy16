...
public class LoadStaticTest{
	 ...
	 */
	publics LoadStaticTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLoadStaticCommand generateNewCommand() {
        CreateLoadStaticCommand command = new CreateLoadStaticCommand( null,  StaticLoadModelKind.values()[0] );
	...
	protected UpdateLoadStaticCommand generateUpdateCommand() {
	        UpdateLoadStaticCommand command = new UpdateLoadStaticCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  StaticLoadModelKind.values()[0],  null );
