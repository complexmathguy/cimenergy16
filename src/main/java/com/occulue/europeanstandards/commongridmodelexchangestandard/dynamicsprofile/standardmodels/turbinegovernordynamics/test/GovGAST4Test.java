...
public class GovGAST4Test{
	 ...
	 * @return		GovGAST4Test
	 */
	publics GovGAST4Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGovGAST4Command generateNewCommand() {
        CreateGovGAST4Command command = new CreateGovGAST4Command( null );
	...
	protected UpdateGovGAST4Command generateUpdateCommand() {
	        UpdateGovGAST4Command command = new UpdateGovGAST4Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
