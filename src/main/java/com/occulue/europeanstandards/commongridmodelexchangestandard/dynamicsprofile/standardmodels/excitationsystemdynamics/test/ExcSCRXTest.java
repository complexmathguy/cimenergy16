...
public class ExcSCRXTest{
	 ...
	 * @return		ExcSCRXTest
	 */
	publics ExcSCRXTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcSCRXCommand generateNewCommand() {
        CreateExcSCRXCommand command = new CreateExcSCRXCommand( null );
	...
	protected UpdateExcSCRXCommand generateUpdateCommand() {
	        UpdateExcSCRXCommand command = new UpdateExcSCRXCommand( null,  null,  null,  null,  null,  null,  null,  null,  null );
