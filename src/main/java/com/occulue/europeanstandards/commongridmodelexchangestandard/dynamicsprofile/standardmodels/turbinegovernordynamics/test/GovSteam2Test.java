...
public class GovSteam2Test{
	 ...
	 */
	publics GovSteam2Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGovSteam2Command generateNewCommand() {
        CreateGovSteam2Command command = new CreateGovSteam2Command( null );
	...
	protected UpdateGovSteam2Command generateUpdateCommand() {
	        UpdateGovSteam2Command command = new UpdateGovSteam2Command( null,  null,  null,  null,  null,  null,  null,  null,  null );
