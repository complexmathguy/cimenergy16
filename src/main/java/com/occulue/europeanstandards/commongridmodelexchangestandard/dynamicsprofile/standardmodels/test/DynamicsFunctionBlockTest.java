...
public class DynamicsFunctionBlockTest{
	 ...
	 */
	publics DynamicsFunctionBlockTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDynamicsFunctionBlockCommand generateNewCommand() {
        CreateDynamicsFunctionBlockCommand command = new CreateDynamicsFunctionBlockCommand( null );
	...
	protected UpdateDynamicsFunctionBlockCommand generateUpdateCommand() {
	        UpdateDynamicsFunctionBlockCommand command = new UpdateDynamicsFunctionBlockCommand( null,  null );
