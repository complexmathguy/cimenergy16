 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.userdefinedmodels.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.userdefinedmodels.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.userdefinedmodels.subscriber.*;
...
public class DiscontinuousExcitationControlUserDefinedTest{
	 ...
	 */
	publics DiscontinuousExcitationControlUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDiscontinuousExcitationControlUserDefinedCommand generateNewCommand() {
        CreateDiscontinuousExcitationControlUserDefinedCommand command = new CreateDiscontinuousExcitationControlUserDefinedCommand( null );
	...
	protected UpdateDiscontinuousExcitationControlUserDefinedCommand generateUpdateCommand() {
	        UpdateDiscontinuousExcitationControlUserDefinedCommand command = new UpdateDiscontinuousExcitationControlUserDefinedCommand( null,  null );
