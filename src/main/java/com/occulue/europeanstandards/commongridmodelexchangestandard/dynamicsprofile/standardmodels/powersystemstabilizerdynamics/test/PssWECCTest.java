...
public class PssWECCTest{
	 ...
	 * @return		PssWECCTest
	 */
	publics PssWECCTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePssWECCCommand generateNewCommand() {
        CreatePssWECCCommand command = new CreatePssWECCCommand( null,  InputSignalKind.values()[0],  InputSignalKind.values()[0] );
	...
	protected UpdatePssWECCCommand generateUpdateCommand() {
	        UpdatePssWECCCommand command = new UpdatePssWECCCommand( null,  InputSignalKind.values()[0],  InputSignalKind.values()[0],  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
