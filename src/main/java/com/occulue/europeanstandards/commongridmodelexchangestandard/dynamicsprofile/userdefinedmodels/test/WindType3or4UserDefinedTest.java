...
public class WindType3or4UserDefinedTest{
	 ...
	 */
	publics WindType3or4UserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindType3or4UserDefinedCommand generateNewCommand() {
        CreateWindType3or4UserDefinedCommand command = new CreateWindType3or4UserDefinedCommand( null );
	...
	protected UpdateWindType3or4UserDefinedCommand generateUpdateCommand() {
	        UpdateWindType3or4UserDefinedCommand command = new UpdateWindType3or4UserDefinedCommand( null,  null );
