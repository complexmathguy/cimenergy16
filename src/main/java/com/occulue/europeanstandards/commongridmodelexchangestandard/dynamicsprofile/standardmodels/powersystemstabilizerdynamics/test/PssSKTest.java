...
public class PssSKTest{
	 ...
	 * @return		PssSKTest
	 */
	publics PssSKTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePssSKCommand generateNewCommand() {
        CreatePssSKCommand command = new CreatePssSKCommand( null );
	...
	protected UpdatePssSKCommand generateUpdateCommand() {
	        UpdatePssSKCommand command = new UpdatePssSKCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
