...
public class ExcBBCTest{
	 ...
	 * @return		ExcBBCTest
	 */
	publics ExcBBCTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcBBCCommand generateNewCommand() {
        CreateExcBBCCommand command = new CreateExcBBCCommand( null );
	...
	protected UpdateExcBBCCommand generateUpdateCommand() {
	        UpdateExcBBCCommand command = new UpdateExcBBCCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
