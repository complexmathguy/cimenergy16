...
public class UnderexcLim2SimplifiedTest{
	 ...
	 */
	publics UnderexcLim2SimplifiedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateUnderexcLim2SimplifiedCommand generateNewCommand() {
        CreateUnderexcLim2SimplifiedCommand command = new CreateUnderexcLim2SimplifiedCommand( null );
	...
	protected UpdateUnderexcLim2SimplifiedCommand generateUpdateCommand() {
	        UpdateUnderexcLim2SimplifiedCommand command = new UpdateUnderexcLim2SimplifiedCommand( null,  null,  null,  null,  null,  null,  null,  null );
