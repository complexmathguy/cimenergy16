...
public class WindTurbineType3or4IECTest{
	 ...
	 */
	publics WindTurbineType3or4IECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateWindTurbineType3or4IECCommand generateUpdateCommand() {
	        UpdateWindTurbineType3or4IECCommand command = new UpdateWindTurbineType3or4IECCommand( null,  null );
