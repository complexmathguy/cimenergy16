...
public class ExcST2ATest{
	 ...
	 * @return		ExcST2ATest
	 */
	publics ExcST2ATest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcST2ACommand generateNewCommand() {
        CreateExcST2ACommand command = new CreateExcST2ACommand( null );
	...
	protected UpdateExcST2ACommand generateUpdateCommand() {
	        UpdateExcST2ACommand command = new UpdateExcST2ACommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
