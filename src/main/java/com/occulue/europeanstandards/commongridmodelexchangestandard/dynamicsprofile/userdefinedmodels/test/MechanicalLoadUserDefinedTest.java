...
public class MechanicalLoadUserDefinedTest{
	 ...
	 */
	publics MechanicalLoadUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateMechanicalLoadUserDefinedCommand generateNewCommand() {
        CreateMechanicalLoadUserDefinedCommand command = new CreateMechanicalLoadUserDefinedCommand( null );
	...
	protected UpdateMechanicalLoadUserDefinedCommand generateUpdateCommand() {
	        UpdateMechanicalLoadUserDefinedCommand command = new UpdateMechanicalLoadUserDefinedCommand( null,  null );
