...
public class PFVArControllerType2UserDefinedTest{
	 ...
	 */
	publics PFVArControllerType2UserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePFVArControllerType2UserDefinedCommand generateNewCommand() {
        CreatePFVArControllerType2UserDefinedCommand command = new CreatePFVArControllerType2UserDefinedCommand( null );
	...
	protected UpdatePFVArControllerType2UserDefinedCommand generateUpdateCommand() {
	        UpdatePFVArControllerType2UserDefinedCommand command = new UpdatePFVArControllerType2UserDefinedCommand( null,  null );
