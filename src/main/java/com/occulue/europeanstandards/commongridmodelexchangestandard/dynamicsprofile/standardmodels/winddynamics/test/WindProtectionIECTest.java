...
public class WindProtectionIECTest{
	 ...
	 */
	publics WindProtectionIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindProtectionIECCommand generateNewCommand() {
        CreateWindProtectionIECCommand command = new CreateWindProtectionIECCommand( null );
	...
	protected UpdateWindProtectionIECCommand generateUpdateCommand() {
	        UpdateWindProtectionIECCommand command = new UpdateWindProtectionIECCommand( null,  null,  null,  null,  null,  null,  null,  null,  null );
