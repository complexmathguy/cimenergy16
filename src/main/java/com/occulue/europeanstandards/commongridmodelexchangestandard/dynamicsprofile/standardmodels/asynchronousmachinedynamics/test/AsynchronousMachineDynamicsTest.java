...
public class AsynchronousMachineDynamicsTest{
	 ...
	 */
	publics AsynchronousMachineDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateAsynchronousMachineDynamicsCommand generateUpdateCommand() {
	        UpdateAsynchronousMachineDynamicsCommand command = new UpdateAsynchronousMachineDynamicsCommand( null,  null );
