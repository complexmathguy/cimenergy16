...
public class PFVArType2IEEEPFControllerTest{
	 ...
	 */
	publics PFVArType2IEEEPFControllerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePFVArType2IEEEPFControllerCommand generateNewCommand() {
        CreatePFVArType2IEEEPFControllerCommand command = new CreatePFVArType2IEEEPFControllerCommand( null );
	...
	protected UpdatePFVArType2IEEEPFControllerCommand generateUpdateCommand() {
	        UpdatePFVArType2IEEEPFControllerCommand command = new UpdatePFVArType2IEEEPFControllerCommand( null,  null,  null,  null,  null,  null,  null,  null );
