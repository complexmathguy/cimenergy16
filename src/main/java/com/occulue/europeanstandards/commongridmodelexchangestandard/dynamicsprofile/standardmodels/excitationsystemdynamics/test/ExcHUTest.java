...
public class ExcHUTest{
	 ...
	 * @return		ExcHUTest
	 */
	publics ExcHUTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcHUCommand generateNewCommand() {
        CreateExcHUCommand command = new CreateExcHUCommand( null );
	...
	protected UpdateExcHUCommand generateUpdateCommand() {
	        UpdateExcHUCommand command = new UpdateExcHUCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
