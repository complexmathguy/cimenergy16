...
public class DiscontinuousExcitationControlDynamicsTest{
	 ...
	 */
	publics DiscontinuousExcitationControlDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateDiscontinuousExcitationControlDynamicsCommand generateUpdateCommand() {
	        UpdateDiscontinuousExcitationControlDynamicsCommand command = new UpdateDiscontinuousExcitationControlDynamicsCommand( null,  null );
