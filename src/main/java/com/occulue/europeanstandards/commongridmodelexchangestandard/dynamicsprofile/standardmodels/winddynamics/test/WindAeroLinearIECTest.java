...
public class WindAeroLinearIECTest{
	 ...
	 */
	publics WindAeroLinearIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindAeroLinearIECCommand generateNewCommand() {
        CreateWindAeroLinearIECCommand command = new CreateWindAeroLinearIECCommand( null );
	...
	protected UpdateWindAeroLinearIECCommand generateUpdateCommand() {
	        UpdateWindAeroLinearIECCommand command = new UpdateWindAeroLinearIECCommand( null,  null,  null,  null,  null,  null );
