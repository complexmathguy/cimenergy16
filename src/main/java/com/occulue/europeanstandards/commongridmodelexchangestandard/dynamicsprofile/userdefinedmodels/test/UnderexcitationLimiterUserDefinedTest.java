...
public class UnderexcitationLimiterUserDefinedTest{
	 ...
	 */
	publics UnderexcitationLimiterUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateUnderexcitationLimiterUserDefinedCommand generateNewCommand() {
        CreateUnderexcitationLimiterUserDefinedCommand command = new CreateUnderexcitationLimiterUserDefinedCommand( null );
	...
	protected UpdateUnderexcitationLimiterUserDefinedCommand generateUpdateCommand() {
	        UpdateUnderexcitationLimiterUserDefinedCommand command = new UpdateUnderexcitationLimiterUserDefinedCommand( null,  null );
