 ...
 *   <li>Improving the available of PFVArControllerType2UserDefined related services in the case of
 *       a PFVArControllerType2UserDefined business related service failing.
 *   <li>Exposes a simpler, uniform PFVArControllerType2UserDefined interface to the business tier,
 ...
 *       PFVArControllerType2UserDefined business related services.
 * </ol>
 *
 * <p>
 *
 ...
 */
public class PFVArControllerType2UserDefinedBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public static PFVArControllerType2UserDefinedBusinessDelegate
   ...
   */
  public CompletableFuture<UUID> createPFVArControllerType2UserDefined(
      CreatePFVArControllerType2UserDefinedCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreatePFVArControllerType2UserDefinedCommand - by convention the future return
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreatePFVArControllerType2UserDefinedCommand of PFVArControllerType2UserDefined is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updatePFVArControllerType2UserDefined(
      UpdatePFVArControllerType2UserDefinedCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeletePFVArControllerType2UserDefinedCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete PFVArControllerType2UserDefined using Id = "
  ...
  /**
   * Method to retrieve the PFVArControllerType2UserDefined via
   * PFVArControllerType2UserDefinedFetchOneSummary
   *
  ...
  public PFVArControllerType2UserDefined getPFVArControllerType2UserDefined(
      PFVArControllerType2UserDefinedFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "PFVArControllerType2UserDefinedFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<PFVArControllerType2UserDefined> futureEntity =
          queryGateway.query(
              new FindPFVArControllerType2UserDefinedQuery(
                  new LoadPFVArControllerType2UserDefinedFilter(
      ...
      final String errMsg =
          "Unable to locate PFVArControllerType2UserDefined with id "
              + summary.getPFVArControllerType2UserDefinedId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
  ...
  public List<PFVArControllerType2UserDefined> getAllPFVArControllerType2UserDefined()
    ...
    try {
      CompletableFuture<List<PFVArControllerType2UserDefined>> futureList =
          queryGateway.query(
  ...
  /**
   * assign Proprietary on PFVArControllerType2UserDefined
   *
   * @param command AssignProprietaryToPFVArControllerType2UserDefinedCommand
   * @exception ProcessingException
   */
  public void assignProprietary(AssignProprietaryToPFVArControllerType2UserDefinedCommand command)
      throws ProcessingException {

    // --------------------------------------------
    // load the parent
    // --------------------------------------------
    load(command.getPFVArControllerType2UserDefinedId());
    ...
    PFVArControllerType2UserDefinedBusinessDelegate parentDelegate =
  ...
  /**
   * unAssign Proprietary on PFVArControllerType2UserDefined
   *
   * @param command UnAssignProprietaryFromPFVArControllerType2UserDefinedCommand
   * @exception ProcessingException
   */
  public void unAssignProprietary(
      UnAssignProprietaryFromPFVArControllerType2UserDefinedCommand command)
      throws ProcessingException {
    ...
    try {
      ...
      final String msg = "Failed to unassign Proprietary on PFVArControllerType2UserDefined";
   ...
   */
  private PFVArControllerType2UserDefined load(UUID id) throws ProcessingException {
    pFVArControllerType2UserDefined =
        PFVArControllerType2UserDefinedBusinessDelegate.getPFVArControllerType2UserDefinedInstance()
            .getPFVArControllerType2UserDefined(
                new PFVArControllerType2UserDefinedFetchOneSummary(id));
    return pFVArControllerType2UserDefined;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(PFVArControllerType2UserDefinedBusinessDelegate.class.getName());
}
