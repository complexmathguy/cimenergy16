...
public class TurbineGovernorDynamicsTest{
	 ...
	 */
	publics TurbineGovernorDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateTurbineGovernorDynamicsCommand generateUpdateCommand() {
	        UpdateTurbineGovernorDynamicsCommand command = new UpdateTurbineGovernorDynamicsCommand( null,  null );
