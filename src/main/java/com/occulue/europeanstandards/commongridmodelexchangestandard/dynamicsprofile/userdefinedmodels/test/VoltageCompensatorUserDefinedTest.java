...
public class VoltageCompensatorUserDefinedTest{
	 ...
	 */
	publics VoltageCompensatorUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVoltageCompensatorUserDefinedCommand generateNewCommand() {
        CreateVoltageCompensatorUserDefinedCommand command = new CreateVoltageCompensatorUserDefinedCommand( null );
	...
	protected UpdateVoltageCompensatorUserDefinedCommand generateUpdateCommand() {
	        UpdateVoltageCompensatorUserDefinedCommand command = new UpdateVoltageCompensatorUserDefinedCommand( null,  null );
