...
public class ExcIEEEST7BTest{
	 ...
	 */
	publics ExcIEEEST7BTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcIEEEST7BCommand generateNewCommand() {
        CreateExcIEEEST7BCommand command = new CreateExcIEEEST7BCommand( null,  ExcST7BOELselectorKind.values()[0],  ExcST7BUELselectorKind.values()[0] );
	...
	protected UpdateExcIEEEST7BCommand generateUpdateCommand() {
	        UpdateExcIEEEST7BCommand command = new UpdateExcIEEEST7BCommand( null,  null,  null,  null,  null,  ExcST7BOELselectorKind.values()[0],  null,  null,  null,  null,  null,  ExcST7BUELselectorKind.values()[0],  null,  null,  null,  null );
