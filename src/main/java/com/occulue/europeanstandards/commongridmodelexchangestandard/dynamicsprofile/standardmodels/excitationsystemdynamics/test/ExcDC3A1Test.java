...
public class ExcDC3A1Test{
	 ...
	 * @return		ExcDC3A1Test
	 */
	publics ExcDC3A1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcDC3A1Command generateNewCommand() {
        CreateExcDC3A1Command command = new CreateExcDC3A1Command( null );
	...
	protected UpdateExcDC3A1Command generateUpdateCommand() {
	        UpdateExcDC3A1Command command = new UpdateExcDC3A1Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
