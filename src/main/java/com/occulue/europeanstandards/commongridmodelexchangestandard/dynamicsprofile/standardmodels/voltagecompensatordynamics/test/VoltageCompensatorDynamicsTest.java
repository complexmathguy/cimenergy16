...
public class VoltageCompensatorDynamicsTest{
	 ...
	 */
	publics VoltageCompensatorDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateVoltageCompensatorDynamicsCommand generateUpdateCommand() {
	        UpdateVoltageCompensatorDynamicsCommand command = new UpdateVoltageCompensatorDynamicsCommand( null,  null );
