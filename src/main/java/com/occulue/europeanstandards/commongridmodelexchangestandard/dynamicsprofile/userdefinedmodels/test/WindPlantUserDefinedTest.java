...
public class WindPlantUserDefinedTest{
	 ...
	 */
	publics WindPlantUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindPlantUserDefinedCommand generateNewCommand() {
        CreateWindPlantUserDefinedCommand command = new CreateWindPlantUserDefinedCommand( null );
	...
	protected UpdateWindPlantUserDefinedCommand generateUpdateCommand() {
	        UpdateWindPlantUserDefinedCommand command = new UpdateWindPlantUserDefinedCommand( null,  null );
