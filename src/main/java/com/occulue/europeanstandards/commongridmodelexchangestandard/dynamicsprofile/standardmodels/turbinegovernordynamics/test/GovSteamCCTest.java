...
public class GovSteamCCTest{
	 ...
	 */
	publics GovSteamCCTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGovSteamCCCommand generateNewCommand() {
        CreateGovSteamCCCommand command = new CreateGovSteamCCCommand( null );
	...
	protected UpdateGovSteamCCCommand generateUpdateCommand() {
	        UpdateGovSteamCCCommand command = new UpdateGovSteamCCCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
