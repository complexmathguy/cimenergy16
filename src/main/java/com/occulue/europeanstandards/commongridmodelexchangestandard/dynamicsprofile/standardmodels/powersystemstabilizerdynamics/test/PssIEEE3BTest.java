...
public class PssIEEE3BTest{
	 ...
	 */
	publics PssIEEE3BTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePssIEEE3BCommand generateNewCommand() {
        CreatePssIEEE3BCommand command = new CreatePssIEEE3BCommand( null,  InputSignalKind.values()[0],  InputSignalKind.values()[0] );
	...
	protected UpdatePssIEEE3BCommand generateUpdateCommand() {
	        UpdatePssIEEE3BCommand command = new UpdatePssIEEE3BCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  InputSignalKind.values()[0],  InputSignalKind.values()[0],  null,  null,  null,  null,  null,  null,  null,  null,  null );
