...
public class LoadMotorTest{
	 ...
	 */
	publics LoadMotorTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLoadMotorCommand generateNewCommand() {
        CreateLoadMotorCommand command = new CreateLoadMotorCommand( null );
	...
	protected UpdateLoadMotorCommand generateUpdateCommand() {
	        UpdateLoadMotorCommand command = new UpdateLoadMotorCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
