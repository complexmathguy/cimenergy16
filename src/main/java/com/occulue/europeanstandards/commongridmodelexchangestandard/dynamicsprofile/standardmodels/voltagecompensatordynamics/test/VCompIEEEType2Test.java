...
public class VCompIEEEType2Test{
	 ...
	 */
	publics VCompIEEEType2Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVCompIEEEType2Command generateNewCommand() {
        CreateVCompIEEEType2Command command = new CreateVCompIEEEType2Command( null );
	...
	protected UpdateVCompIEEEType2Command generateUpdateCommand() {
	        UpdateVCompIEEEType2Command command = new UpdateVCompIEEEType2Command( null,  null );
