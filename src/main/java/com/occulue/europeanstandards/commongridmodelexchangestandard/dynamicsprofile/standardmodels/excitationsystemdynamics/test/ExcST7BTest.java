...
public class ExcST7BTest{
	 ...
	 * @return		ExcST7BTest
	 */
	publics ExcST7BTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcST7BCommand generateNewCommand() {
        CreateExcST7BCommand command = new CreateExcST7BCommand( null,  ExcST7BOELselectorKind.values()[0],  ExcST7BUELselectorKind.values()[0] );
	...
	protected UpdateExcST7BCommand generateUpdateCommand() {
	        UpdateExcST7BCommand command = new UpdateExcST7BCommand( null,  null,  null,  null,  null,  ExcST7BOELselectorKind.values()[0],  null,  null,  null,  null,  null,  null,  ExcST7BUELselectorKind.values()[0],  null,  null,  null,  null );
