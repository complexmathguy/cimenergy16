 ...
 *   <li>Improving the available of WindTurbineType4aIEC related services in the case of a
 *       WindTurbineType4aIEC business related service failing.
 *   <li>Exposes a simpler, uniform WindTurbineType4aIEC interface to the business tier, making it
 *       easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill WindTurbineType4aIEC
 ...
 */
public class WindTurbineType4aIECBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createWindTurbineType4aIEC(
      CreateWindTurbineType4aIECCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateWindTurbineType4aIECCommand - by convention the future return value for a
      // create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateWindTurbineType4aIECCommand of WindTurbineType4aIEC is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateWindTurbineType4aIEC(
      UpdateWindTurbineType4aIECCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteWindTurbineType4aIECCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete WindTurbineType4aIEC using Id = " + command.getWindTurbineType4aIECId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
  ...
  public WindTurbineType4aIEC getWindTurbineType4aIEC(WindTurbineType4aIECFetchOneSummary summary)
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<WindTurbineType4aIEC> futureEntity =
          queryGateway.query(
              new FindWindTurbineType4aIECQuery(
                  new LoadWindTurbineType4aIECFilter(summary.getWindTurbineType4aIECId())),
              ResponseTypes.instanceOf(WindTurbineType4aIEC.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate WindTurbineType4aIEC with id " + summary.getWindTurbineType4aIECId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
   ...
   */
  public List<WindTurbineType4aIEC> getAllWindTurbineType4aIEC() throws ProcessingException {
    List<WindTurbineType4aIEC> list = null;

    try {
      CompletableFuture<List<WindTurbineType4aIEC>> futureList =
          queryGateway.query(
              new FindAllWindTurbineType4aIECQuery(),
  ...
  /**
   * assign WindTurbineType4aIEC on WindTurbineType4aIEC
   *
   * @param command AssignWindTurbineType4aIECToWindTurbineType4aIECCommand
   * @exception ProcessingException
   */
  public void assignWindTurbineType4aIEC(
      AssignWindTurbineType4aIECToWindTurbineType4aIECCommand command) throws ProcessingException {

    // --------------------------------------------
    // load the parent
    // --------------------------------------------
    load(command.getWindTurbineType4aIECId());

    com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels
            .winddynamics.delegate.WindTurbineType4aIECBusinessDelegate
        childDelegate =
            com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile
                .standardmodels.winddynamics.delegate.WindTurbineType4aIECBusinessDelegate
                .getWindTurbineType4aIECInstance();
    WindTurbineType4aIECBusinessDelegate parentDelegate =
        WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance();
    UUID childId = command.getAssignment().getWindTurbineType4aIECId();
    WindTurbineType4aIEC child = null;
    ...
    try {
      ...
      final String msg = "Failed to get WindTurbineType4aIEC using id " + childId;
  ...
  public void unAssignWindTurbineType4aIEC(
    ...
    try {
      ...
      final String msg = "Failed to unassign WindTurbineType4aIEC on WindTurbineType4aIEC";
   ...
   */
  private WindTurbineType4aIEC load(UUID id) throws ProcessingException {
    windTurbineType4aIEC =
        WindTurbineType4aIECBusinessDelegate.getWindTurbineType4aIECInstance()
            .getWindTurbineType4aIEC(new WindTurbineType4aIECFetchOneSummary(id));
    return windTurbineType4aIEC;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindTurbineType4aIECBusinessDelegate.class.getName());
}
