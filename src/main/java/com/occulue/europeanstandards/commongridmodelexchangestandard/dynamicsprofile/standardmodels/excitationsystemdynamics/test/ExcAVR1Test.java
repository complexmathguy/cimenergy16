...
public class ExcAVR1Test{
	 ...
	 * @return		ExcAVR1Test
	 */
	publics ExcAVR1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcAVR1Command generateNewCommand() {
        CreateExcAVR1Command command = new CreateExcAVR1Command( null );
	...
	protected UpdateExcAVR1Command generateUpdateCommand() {
	        UpdateExcAVR1Command command = new UpdateExcAVR1Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
