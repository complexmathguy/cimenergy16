 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.pfvarcontrollertype2dynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.pfvarcontrollertype2dynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.pfvarcontrollertype2dynamics.subscriber.*;
...
public class PFVArType2IEEEVArControllerTest{
	 ...
	 */
	publics PFVArType2IEEEVArControllerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePFVArType2IEEEVArControllerCommand generateNewCommand() {
        CreatePFVArType2IEEEVArControllerCommand command = new CreatePFVArType2IEEEVArControllerCommand( null );
	...
	protected UpdatePFVArType2IEEEVArControllerCommand generateUpdateCommand() {
	        UpdatePFVArType2IEEEVArControllerCommand command = new UpdatePFVArType2IEEEVArControllerCommand( null,  null,  null,  null,  null,  null,  null,  null );
