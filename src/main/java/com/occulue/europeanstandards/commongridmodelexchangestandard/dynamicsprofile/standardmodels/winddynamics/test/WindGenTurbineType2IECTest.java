...
public class WindGenTurbineType2IECTest{
	 ...
	 */
	publics WindGenTurbineType2IECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateWindGenTurbineType2IECCommand generateUpdateCommand() {
	        UpdateWindGenTurbineType2IECCommand command = new UpdateWindGenTurbineType2IECCommand( null,  null );
