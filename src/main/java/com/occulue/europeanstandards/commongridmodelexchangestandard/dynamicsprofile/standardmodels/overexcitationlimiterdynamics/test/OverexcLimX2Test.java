 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.overexcitationlimiterdynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.overexcitationlimiterdynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.overexcitationlimiterdynamics.subscriber.*;
...
public class OverexcLimX2Test{
	 ...
	 */
	publics OverexcLimX2Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateOverexcLimX2Command generateNewCommand() {
        CreateOverexcLimX2Command command = new CreateOverexcLimX2Command( null );
	...
	protected UpdateOverexcLimX2Command generateUpdateCommand() {
	        UpdateOverexcLimX2Command command = new UpdateOverexcLimX2Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
