...
public class WindTurbineType1or2IECTest{
	 ...
	 */
	publics WindTurbineType1or2IECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateWindTurbineType1or2IECCommand generateUpdateCommand() {
	        UpdateWindTurbineType1or2IECCommand command = new UpdateWindTurbineType1or2IECCommand( null,  null );
