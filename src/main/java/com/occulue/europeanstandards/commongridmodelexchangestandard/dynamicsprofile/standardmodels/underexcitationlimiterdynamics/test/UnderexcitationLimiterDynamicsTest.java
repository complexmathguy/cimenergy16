...
public class UnderexcitationLimiterDynamicsTest{
	 ...
	 */
	publics UnderexcitationLimiterDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateUnderexcitationLimiterDynamicsCommand generateUpdateCommand() {
	        UpdateUnderexcitationLimiterDynamicsCommand command = new UpdateUnderexcitationLimiterDynamicsCommand( null,  null );
