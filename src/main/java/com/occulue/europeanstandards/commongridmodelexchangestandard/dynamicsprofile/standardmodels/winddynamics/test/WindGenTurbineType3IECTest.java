...
public class WindGenTurbineType3IECTest{
	 ...
	 */
	publics WindGenTurbineType3IECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindGenTurbineType3IECCommand generateNewCommand() {
        CreateWindGenTurbineType3IECCommand command = new CreateWindGenTurbineType3IECCommand( null );
	...
	protected UpdateWindGenTurbineType3IECCommand generateUpdateCommand() {
	        UpdateWindGenTurbineType3IECCommand command = new UpdateWindGenTurbineType3IECCommand( null,  null,  null,  null );
