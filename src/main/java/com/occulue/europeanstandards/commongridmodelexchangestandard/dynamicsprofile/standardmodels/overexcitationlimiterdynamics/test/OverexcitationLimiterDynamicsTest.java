...
public class OverexcitationLimiterDynamicsTest{
	 ...
	 */
	publics OverexcitationLimiterDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateOverexcitationLimiterDynamicsCommand generateUpdateCommand() {
	        UpdateOverexcitationLimiterDynamicsCommand command = new UpdateOverexcitationLimiterDynamicsCommand( null,  null );
