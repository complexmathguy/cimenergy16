...
public class WindPitchContEmulIECTest{
	 ...
	 */
	publics WindPitchContEmulIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindPitchContEmulIECCommand generateNewCommand() {
        CreateWindPitchContEmulIECCommand command = new CreateWindPitchContEmulIECCommand( null );
	...
	protected UpdateWindPitchContEmulIECCommand generateUpdateCommand() {
	        UpdateWindPitchContEmulIECCommand command = new UpdateWindPitchContEmulIECCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
