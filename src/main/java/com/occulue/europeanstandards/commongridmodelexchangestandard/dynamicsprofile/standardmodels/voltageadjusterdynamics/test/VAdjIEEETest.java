 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.voltageadjusterdynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.voltageadjusterdynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.voltageadjusterdynamics.subscriber.*;
...
public class VAdjIEEETest{
	 ...
	 * @return		VAdjIEEETest
	 */
	publics VAdjIEEETest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVAdjIEEECommand generateNewCommand() {
        CreateVAdjIEEECommand command = new CreateVAdjIEEECommand( null );
	...
	protected UpdateVAdjIEEECommand generateUpdateCommand() {
	        UpdateVAdjIEEECommand command = new UpdateVAdjIEEECommand( null,  null,  null,  null,  null,  null,  null );
