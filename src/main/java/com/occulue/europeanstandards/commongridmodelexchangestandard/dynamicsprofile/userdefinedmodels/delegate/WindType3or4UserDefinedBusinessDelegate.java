 ...
 *   <li>Improving the available of WindType3or4UserDefined related services in the case of a
 *       WindType3or4UserDefined business related service failing.
 *   <li>Exposes a simpler, uniform WindType3or4UserDefined interface to the business tier, making
 *       it easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill WindType3or4UserDefined
 ...
 */
public class WindType3or4UserDefinedBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createWindType3or4UserDefined(
      CreateWindType3or4UserDefinedCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateWindType3or4UserDefinedCommand - by convention the future return value for
      // a create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateWindType3or4UserDefinedCommand of WindType3or4UserDefined is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateWindType3or4UserDefined(
      UpdateWindType3or4UserDefinedCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteWindType3or4UserDefinedCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete WindType3or4UserDefined using Id = "
  ...
  public WindType3or4UserDefined getWindType3or4UserDefined(
      WindType3or4UserDefinedFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "WindType3or4UserDefinedFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<WindType3or4UserDefined> futureEntity =
          queryGateway.query(
              new FindWindType3or4UserDefinedQuery(
                  new LoadWindType3or4UserDefinedFilter(summary.getWindType3or4UserDefinedId())),
              ResponseTypes.instanceOf(WindType3or4UserDefined.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate WindType3or4UserDefined with id "
   ...
   */
  public List<WindType3or4UserDefined> getAllWindType3or4UserDefined() throws ProcessingException {
    List<WindType3or4UserDefined> list = null;

    try {
      CompletableFuture<List<WindType3or4UserDefined>> futureList =
          queryGateway.query(
  ...
  /**
   * assign Proprietary on WindType3or4UserDefined
   *
   * @param command AssignProprietaryToWindType3or4UserDefinedCommand
   * @exception ProcessingException
   */
  public void assignProprietary(AssignProprietaryToWindType3or4UserDefinedCommand command)
      throws ProcessingException {

    // --------------------------------------------
    // load the parent
    // --------------------------------------------
    load(command.getWindType3or4UserDefinedId());
    ...
    WindType3or4UserDefinedBusinessDelegate parentDelegate =
   ...
   * @exception ProcessingException
   */
  public void unAssignProprietary(UnAssignProprietaryFromWindType3or4UserDefinedCommand command)
      throws ProcessingException {
    ...
    try {
      ...
      final String msg = "Failed to unassign Proprietary on WindType3or4UserDefined";
   ...
   */
  private WindType3or4UserDefined load(UUID id) throws ProcessingException {
    windType3or4UserDefined =
        WindType3or4UserDefinedBusinessDelegate.getWindType3or4UserDefinedInstance()
            .getWindType3or4UserDefined(new WindType3or4UserDefinedFetchOneSummary(id));
    return windType3or4UserDefined;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindType3or4UserDefinedBusinessDelegate.class.getName());
}
