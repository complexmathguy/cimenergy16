...
public class VoltageAdjusterUserDefinedTest{
	 ...
	 */
	publics VoltageAdjusterUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVoltageAdjusterUserDefinedCommand generateNewCommand() {
        CreateVoltageAdjusterUserDefinedCommand command = new CreateVoltageAdjusterUserDefinedCommand( null );
	...
	protected UpdateVoltageAdjusterUserDefinedCommand generateUpdateCommand() {
	        UpdateVoltageAdjusterUserDefinedCommand command = new UpdateVoltageAdjusterUserDefinedCommand( null,  null );
