...
public class PssELIN2Test{
	 ...
	 * @return		PssELIN2Test
	 */
	publics PssELIN2Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePssELIN2Command generateNewCommand() {
        CreatePssELIN2Command command = new CreatePssELIN2Command( null );
	...
	protected UpdatePssELIN2Command generateUpdateCommand() {
	        UpdatePssELIN2Command command = new UpdatePssELIN2Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
