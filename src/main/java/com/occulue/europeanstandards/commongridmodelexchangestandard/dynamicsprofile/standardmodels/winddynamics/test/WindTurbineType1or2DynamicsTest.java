...
public class WindTurbineType1or2DynamicsTest{
	 ...
	 */
	publics WindTurbineType1or2DynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateWindTurbineType1or2DynamicsCommand generateUpdateCommand() {
	        UpdateWindTurbineType1or2DynamicsCommand command = new UpdateWindTurbineType1or2DynamicsCommand( null,  null );
