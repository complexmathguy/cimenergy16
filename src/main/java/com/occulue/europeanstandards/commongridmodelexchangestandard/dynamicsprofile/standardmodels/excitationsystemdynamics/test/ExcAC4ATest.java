...
public class ExcAC4ATest{
	 ...
	 * @return		ExcAC4ATest
	 */
	publics ExcAC4ATest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcAC4ACommand generateNewCommand() {
        CreateExcAC4ACommand command = new CreateExcAC4ACommand( null );
	...
	protected UpdateExcAC4ACommand generateUpdateCommand() {
	        UpdateExcAC4ACommand command = new UpdateExcAC4ACommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
