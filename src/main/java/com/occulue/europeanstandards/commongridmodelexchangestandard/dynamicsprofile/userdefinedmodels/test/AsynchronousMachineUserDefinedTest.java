...
public class AsynchronousMachineUserDefinedTest{
	 ...
	 */
	publics AsynchronousMachineUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAsynchronousMachineUserDefinedCommand generateNewCommand() {
        CreateAsynchronousMachineUserDefinedCommand command = new CreateAsynchronousMachineUserDefinedCommand( null );
	...
	protected UpdateAsynchronousMachineUserDefinedCommand generateUpdateCommand() {
	        UpdateAsynchronousMachineUserDefinedCommand command = new UpdateAsynchronousMachineUserDefinedCommand( null,  null );
