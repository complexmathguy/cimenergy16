 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.winddynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.winddynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.winddynamics.subscriber.*;
...
public class WindContQIECTest{
	 ...
	 */
	publics WindContQIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindContQIECCommand generateNewCommand() {
        CreateWindContQIECCommand command = new CreateWindContQIECCommand( null,  WindLVRTQcontrolModesKind.values()[0],  WindQcontrolModesKind.values()[0] );
	...
	protected UpdateWindContQIECCommand generateUpdateCommand() {
	        UpdateWindContQIECCommand command = new UpdateWindContQIECCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  WindLVRTQcontrolModesKind.values()[0],  WindQcontrolModesKind.values()[0],  null );
