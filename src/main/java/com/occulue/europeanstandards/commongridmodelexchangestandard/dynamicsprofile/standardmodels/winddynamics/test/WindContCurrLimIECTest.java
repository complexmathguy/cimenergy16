...
public class WindContCurrLimIECTest{
	 ...
	 */
	publics WindContCurrLimIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateWindContCurrLimIECCommand generateUpdateCommand() {
	        UpdateWindContCurrLimIECCommand command = new UpdateWindContCurrLimIECCommand( null,  null,  null,  null,  null,  null );
