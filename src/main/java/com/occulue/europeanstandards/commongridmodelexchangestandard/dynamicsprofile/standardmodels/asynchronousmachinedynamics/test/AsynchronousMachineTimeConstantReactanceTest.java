 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.asynchronousmachinedynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.asynchronousmachinedynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.asynchronousmachinedynamics.subscriber.*;
...
public class AsynchronousMachineTimeConstantReactanceTest{
	 ...
	 */
	publics AsynchronousMachineTimeConstantReactanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAsynchronousMachineTimeConstantReactanceCommand generateNewCommand() {
        CreateAsynchronousMachineTimeConstantReactanceCommand command = new CreateAsynchronousMachineTimeConstantReactanceCommand( null );
	...
	protected UpdateAsynchronousMachineTimeConstantReactanceCommand generateUpdateCommand() {
	        UpdateAsynchronousMachineTimeConstantReactanceCommand command = new UpdateAsynchronousMachineTimeConstantReactanceCommand( null,  null,  null,  null,  null,  null );
