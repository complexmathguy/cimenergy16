...
public class VoltageAdjusterDynamicsTest{
	 ...
	 */
	publics VoltageAdjusterDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateVoltageAdjusterDynamicsCommand generateUpdateCommand() {
	        UpdateVoltageAdjusterDynamicsCommand command = new UpdateVoltageAdjusterDynamicsCommand( null,  null );
