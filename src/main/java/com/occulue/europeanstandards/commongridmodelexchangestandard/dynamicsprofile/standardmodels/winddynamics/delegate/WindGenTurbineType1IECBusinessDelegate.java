 ...
 *   <li>Improving the available of WindGenTurbineType1IEC related services in the case of a
 *       WindGenTurbineType1IEC business related service failing.
 *   <li>Exposes a simpler, uniform WindGenTurbineType1IEC interface to the business tier, making it
 *       easy for clients to consume a simple Java object.
 *   <li>Hides the communication protocol that may be required to fulfill WindGenTurbineType1IEC
 ...
 */
public class WindGenTurbineType1IECBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public CompletableFuture<UUID> createWindGenTurbineType1IEC(
      CreateWindGenTurbineType1IECCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateWindGenTurbineType1IECCommand - by convention the future return value for a
      // create command
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateWindGenTurbineType1IECCommand of WindGenTurbineType1IEC is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateWindGenTurbineType1IEC(
      UpdateWindGenTurbineType1IECCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteWindGenTurbineType1IECCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete WindGenTurbineType1IEC using Id = "
  ...
  public WindGenTurbineType1IEC getWindGenTurbineType1IEC(
      WindGenTurbineType1IECFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "WindGenTurbineType1IECFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<WindGenTurbineType1IEC> futureEntity =
          queryGateway.query(
              new FindWindGenTurbineType1IECQuery(
                  new LoadWindGenTurbineType1IECFilter(summary.getWindGenTurbineType1IECId())),
              ResponseTypes.instanceOf(WindGenTurbineType1IEC.class));

      entity = futureEntity.get();
    } catch (Exception exc) {
      final String errMsg =
          "Unable to locate WindGenTurbineType1IEC with id "
   ...
   */
  public List<WindGenTurbineType1IEC> getAllWindGenTurbineType1IEC() throws ProcessingException {
    List<WindGenTurbineType1IEC> list = null;

    try {
      CompletableFuture<List<WindGenTurbineType1IEC>> futureList =
          queryGateway.query(
  ...
  /**
   * assign WindGenTurbineType1IEC on WindGenTurbineType1IEC
   *
   * @param command AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand
   * @exception ProcessingException
   */
  public void assignWindGenTurbineType1IEC(
      AssignWindGenTurbineType1IECToWindGenTurbineType1IECCommand command)
      throws ProcessingException {

    // --------------------------------------------
    // load the parent
    // --------------------------------------------
    load(command.getWindGenTurbineType1IECId());

    com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels
            .winddynamics.delegate.WindGenTurbineType1IECBusinessDelegate
        childDelegate =
            com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile
                .standardmodels.winddynamics.delegate.WindGenTurbineType1IECBusinessDelegate
                .getWindGenTurbineType1IECInstance();
    WindGenTurbineType1IECBusinessDelegate parentDelegate =
        WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance();
    UUID childId = command.getAssignment().getWindGenTurbineType1IECId();
    WindGenTurbineType1IEC child = null;
    ...
    try {
      ...
      final String msg = "Failed to get WindGenTurbineType1IEC using id " + childId;
  ...
  public void unAssignWindGenTurbineType1IEC(
    ...
    try {
      ...
      final String msg = "Failed to unassign WindGenTurbineType1IEC on WindGenTurbineType1IEC";
   ...
   */
  private WindGenTurbineType1IEC load(UUID id) throws ProcessingException {
    windGenTurbineType1IEC =
        WindGenTurbineType1IECBusinessDelegate.getWindGenTurbineType1IECInstance()
            .getWindGenTurbineType1IEC(new WindGenTurbineType1IECFetchOneSummary(id));
    return windGenTurbineType1IEC;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(WindGenTurbineType1IECBusinessDelegate.class.getName());
}
