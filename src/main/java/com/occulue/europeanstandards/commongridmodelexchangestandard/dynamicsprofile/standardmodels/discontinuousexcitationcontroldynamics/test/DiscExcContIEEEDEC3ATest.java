...
public class DiscExcContIEEEDEC3ATest{
	 ...
	 */
	publics DiscExcContIEEEDEC3ATest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDiscExcContIEEEDEC3ACommand generateNewCommand() {
        CreateDiscExcContIEEEDEC3ACommand command = new CreateDiscExcContIEEEDEC3ACommand( null );
	...
	protected UpdateDiscExcContIEEEDEC3ACommand generateUpdateCommand() {
	        UpdateDiscExcContIEEEDEC3ACommand command = new UpdateDiscExcContIEEEDEC3ACommand( null,  null,  null );
