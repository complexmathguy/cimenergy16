...
public class ExcAVR5Test{
	 ...
	 * @return		ExcAVR5Test
	 */
	publics ExcAVR5Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcAVR5Command generateNewCommand() {
        CreateExcAVR5Command command = new CreateExcAVR5Command( null );
	...
	protected UpdateExcAVR5Command generateUpdateCommand() {
	        UpdateExcAVR5Command command = new UpdateExcAVR5Command( null,  null,  null,  null );
