...
public class ExcCZTest{
	 ...
	 * @return		ExcCZTest
	 */
	publics ExcCZTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcCZCommand generateNewCommand() {
        CreateExcCZCommand command = new CreateExcCZCommand( null );
	...
	protected UpdateExcCZCommand generateUpdateCommand() {
	        UpdateExcCZCommand command = new UpdateExcCZCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
