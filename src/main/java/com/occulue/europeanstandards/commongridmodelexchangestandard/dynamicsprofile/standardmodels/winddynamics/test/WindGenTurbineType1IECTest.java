...
public class WindGenTurbineType1IECTest{
	 ...
	 */
	publics WindGenTurbineType1IECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateWindGenTurbineType1IECCommand generateUpdateCommand() {
	        UpdateWindGenTurbineType1IECCommand command = new UpdateWindGenTurbineType1IECCommand( null,  null );
