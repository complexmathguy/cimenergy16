...
public class WindContPType4aIECTest{
	 ...
	 */
	publics WindContPType4aIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindContPType4aIECCommand generateNewCommand() {
        CreateWindContPType4aIECCommand command = new CreateWindContPType4aIECCommand( null );
	...
	protected UpdateWindContPType4aIECCommand generateUpdateCommand() {
	        UpdateWindContPType4aIECCommand command = new UpdateWindContPType4aIECCommand( null,  null,  null,  null );
