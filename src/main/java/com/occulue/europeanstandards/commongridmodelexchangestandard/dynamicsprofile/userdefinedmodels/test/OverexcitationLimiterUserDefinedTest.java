...
public class OverexcitationLimiterUserDefinedTest{
	 ...
	 */
	publics OverexcitationLimiterUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateOverexcitationLimiterUserDefinedCommand generateNewCommand() {
        CreateOverexcitationLimiterUserDefinedCommand command = new CreateOverexcitationLimiterUserDefinedCommand( null );
	...
	protected UpdateOverexcitationLimiterUserDefinedCommand generateUpdateCommand() {
	        UpdateOverexcitationLimiterUserDefinedCommand command = new UpdateOverexcitationLimiterUserDefinedCommand( null,  null );
