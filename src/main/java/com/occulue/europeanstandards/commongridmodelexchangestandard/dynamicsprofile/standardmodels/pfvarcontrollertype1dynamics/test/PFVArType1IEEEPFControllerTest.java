 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.pfvarcontrollertype1dynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.pfvarcontrollertype1dynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.pfvarcontrollertype1dynamics.subscriber.*;
...
public class PFVArType1IEEEPFControllerTest{
	 ...
	 */
	publics PFVArType1IEEEPFControllerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePFVArType1IEEEPFControllerCommand generateNewCommand() {
        CreatePFVArType1IEEEPFControllerCommand command = new CreatePFVArType1IEEEPFControllerCommand( null );
	...
	protected UpdatePFVArType1IEEEPFControllerCommand generateUpdateCommand() {
	        UpdatePFVArType1IEEEPFControllerCommand command = new UpdatePFVArType1IEEEPFControllerCommand( null,  null,  null,  null,  null,  null,  null,  null,  null );
