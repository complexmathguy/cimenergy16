...
public class PFVArControllerType1UserDefinedTest{
	 ...
	 */
	publics PFVArControllerType1UserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePFVArControllerType1UserDefinedCommand generateNewCommand() {
        CreatePFVArControllerType1UserDefinedCommand command = new CreatePFVArControllerType1UserDefinedCommand( null );
	...
	protected UpdatePFVArControllerType1UserDefinedCommand generateUpdateCommand() {
	        UpdatePFVArControllerType1UserDefinedCommand command = new UpdatePFVArControllerType1UserDefinedCommand( null,  null );
