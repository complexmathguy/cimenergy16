...
public class PssIEEE1ATest{
	 ...
	 */
	publics PssIEEE1ATest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePssIEEE1ACommand generateNewCommand() {
        CreatePssIEEE1ACommand command = new CreatePssIEEE1ACommand( null,  InputSignalKind.values()[0] );
	...
	protected UpdatePssIEEE1ACommand generateUpdateCommand() {
	        UpdatePssIEEE1ACommand command = new UpdatePssIEEE1ACommand( null,  null,  null,  InputSignalKind.values()[0],  null,  null,  null,  null,  null,  null,  null,  null,  null );
