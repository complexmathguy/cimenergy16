...
public class ExcitationSystemDynamicsTest{
	 ...
	 */
	publics ExcitationSystemDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateExcitationSystemDynamicsCommand generateUpdateCommand() {
	        UpdateExcitationSystemDynamicsCommand command = new UpdateExcitationSystemDynamicsCommand( null,  null );
