 ...
 *   <li>Improving the available of SynchronousMachineSimplified related services in the case of a
 *       SynchronousMachineSimplified business related service failing.
 *   <li>Exposes a simpler, uniform SynchronousMachineSimplified interface to the business tier,
 ...
 *       SynchronousMachineSimplified business related services.
 * </ol>
 *
 * <p>
 *
 ...
 */
public class SynchronousMachineSimplifiedBusinessDelegate extends BaseBusinessDelegate {
  // ************************************************************************
  // Public Methods
  // ************************************************************************
  /** Default Constructor */
   ...
   */
  public static SynchronousMachineSimplifiedBusinessDelegate
      getSynchronousMachineSimplifiedInstance() {
   ...
   */
  public CompletableFuture<UUID> createSynchronousMachineSimplified(
      CreateSynchronousMachineSimplifiedCommand command)
    ...
    try {
      ...
      // ---------------------------------------
      // issue the CreateSynchronousMachineSimplifiedCommand - by convention the future return value
      ...
      LOGGER.log(
          Level.INFO,
          "return from Command Gateway for CreateSynchronousMachineSimplifiedCommand of SynchronousMachineSimplified is "
              + command);
   ...
   * @exception IllegalArgumentException
   */
  public CompletableFuture<Void> updateSynchronousMachineSimplified(
      UpdateSynchronousMachineSimplifiedCommand command)
      throws ProcessingException, IllegalArgumentException {
  ...
  public CompletableFuture<Void> delete(DeleteSynchronousMachineSimplifiedCommand command)
    ...
    try {
      ...
      final String errMsg =
          "Unable to delete SynchronousMachineSimplified using Id = "
              + command.getSynchronousMachineSimplifiedId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
    }
  ...
  /**
   * Method to retrieve the SynchronousMachineSimplified via
   * SynchronousMachineSimplifiedFetchOneSummary
   *
   ...
   * @exception IllegalArgumentException
   */
  public SynchronousMachineSimplified getSynchronousMachineSimplified(
      SynchronousMachineSimplifiedFetchOneSummary summary)
      throws ProcessingException, IllegalArgumentException {

    if (summary == null)
      throw new IllegalArgumentException(
          "SynchronousMachineSimplifiedFetchOneSummary arg cannot be null");
    ...
    try {
      ...
      // --------------------------------------
      CompletableFuture<SynchronousMachineSimplified> futureEntity =
          queryGateway.query(
              new FindSynchronousMachineSimplifiedQuery(
                  new LoadSynchronousMachineSimplifiedFilter(
      ...
      final String errMsg =
          "Unable to locate SynchronousMachineSimplified with id "
              + summary.getSynchronousMachineSimplifiedId();
      LOGGER.log(Level.WARNING, errMsg, exc);
      throw new ProcessingException(errMsg, exc);
    } finally {
  ...
  public List<SynchronousMachineSimplified> getAllSynchronousMachineSimplified()
    ...
    try {
      CompletableFuture<List<SynchronousMachineSimplified>> futureList =
          queryGateway.query(
   ...
   */
  private SynchronousMachineSimplified load(UUID id) throws ProcessingException {
    synchronousMachineSimplified =
        SynchronousMachineSimplifiedBusinessDelegate.getSynchronousMachineSimplifiedInstance()
            .getSynchronousMachineSimplified(new SynchronousMachineSimplifiedFetchOneSummary(id));
    return synchronousMachineSimplified;
  }
  ...
  private static final Logger LOGGER =
      Logger.getLogger(SynchronousMachineSimplifiedBusinessDelegate.class.getName());
}
