...
public class GovHydroIEEE0Test{
	 ...
	 */
	publics GovHydroIEEE0Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGovHydroIEEE0Command generateNewCommand() {
        CreateGovHydroIEEE0Command command = new CreateGovHydroIEEE0Command( null );
	...
	protected UpdateGovHydroIEEE0Command generateUpdateCommand() {
	        UpdateGovHydroIEEE0Command command = new UpdateGovHydroIEEE0Command( null,  null,  null,  null,  null,  null,  null,  null,  null );
