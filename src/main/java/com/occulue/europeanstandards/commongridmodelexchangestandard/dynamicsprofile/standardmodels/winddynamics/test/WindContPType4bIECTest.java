...
public class WindContPType4bIECTest{
	 ...
	 */
	publics WindContPType4bIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindContPType4bIECCommand generateNewCommand() {
        CreateWindContPType4bIECCommand command = new CreateWindContPType4bIECCommand( null );
	...
	protected UpdateWindContPType4bIECCommand generateUpdateCommand() {
	        UpdateWindContPType4bIECCommand command = new UpdateWindContPType4bIECCommand( null,  null,  null,  null,  null );
