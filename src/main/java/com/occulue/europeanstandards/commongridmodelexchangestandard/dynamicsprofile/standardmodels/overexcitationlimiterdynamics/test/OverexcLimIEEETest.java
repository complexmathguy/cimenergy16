...
public class OverexcLimIEEETest{
	 ...
	 */
	publics OverexcLimIEEETest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateOverexcLimIEEECommand generateNewCommand() {
        CreateOverexcLimIEEECommand command = new CreateOverexcLimIEEECommand( null );
	...
	protected UpdateOverexcLimIEEECommand generateUpdateCommand() {
	        UpdateOverexcLimIEEECommand command = new UpdateOverexcLimIEEECommand( null,  null,  null,  null,  null,  null,  null );
