...
public class WindGenType4IECTest{
	 ...
	 */
	publics WindGenType4IECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindGenType4IECCommand generateNewCommand() {
        CreateWindGenType4IECCommand command = new CreateWindGenType4IECCommand( null );
	...
	protected UpdateWindGenType4IECCommand generateUpdateCommand() {
	        UpdateWindGenType4IECCommand command = new UpdateWindGenType4IECCommand( null,  null,  null,  null,  null );
