...
public class ExcAVR2Test{
	 ...
	 * @return		ExcAVR2Test
	 */
	publics ExcAVR2Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcAVR2Command generateNewCommand() {
        CreateExcAVR2Command command = new CreateExcAVR2Command( null );
	...
	protected UpdateExcAVR2Command generateUpdateCommand() {
	        UpdateExcAVR2Command command = new UpdateExcAVR2Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
