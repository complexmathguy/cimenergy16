...
public class GovSteamSGOTest{
	 ...
	 */
	publics GovSteamSGOTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGovSteamSGOCommand generateNewCommand() {
        CreateGovSteamSGOCommand command = new CreateGovSteamSGOCommand( null );
	...
	protected UpdateGovSteamSGOCommand generateUpdateCommand() {
	        UpdateGovSteamSGOCommand command = new UpdateGovSteamSGOCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
