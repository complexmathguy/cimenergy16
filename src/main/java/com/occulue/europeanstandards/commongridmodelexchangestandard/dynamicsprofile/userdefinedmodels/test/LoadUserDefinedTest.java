...
public class LoadUserDefinedTest{
	 ...
	 */
	publics LoadUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLoadUserDefinedCommand generateNewCommand() {
        CreateLoadUserDefinedCommand command = new CreateLoadUserDefinedCommand( null );
	...
	protected UpdateLoadUserDefinedCommand generateUpdateCommand() {
	        UpdateLoadUserDefinedCommand command = new UpdateLoadUserDefinedCommand( null,  null );
