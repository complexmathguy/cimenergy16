 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.voltagecompensatordynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.voltagecompensatordynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.voltagecompensatordynamics.subscriber.*;
...
public class GenICompensationForGenJTest{
	 ...
	 */
	publics GenICompensationForGenJTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGenICompensationForGenJCommand generateNewCommand() {
        CreateGenICompensationForGenJCommand command = new CreateGenICompensationForGenJCommand( null );
	...
	protected UpdateGenICompensationForGenJCommand generateUpdateCommand() {
	        UpdateGenICompensationForGenJCommand command = new UpdateGenICompensationForGenJCommand( null,  null,  null,  new HashSet<>() );
