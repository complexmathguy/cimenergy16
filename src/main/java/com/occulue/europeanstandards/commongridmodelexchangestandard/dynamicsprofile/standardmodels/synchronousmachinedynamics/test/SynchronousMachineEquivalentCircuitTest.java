...
public class SynchronousMachineEquivalentCircuitTest{
	 ...
	 */
	publics SynchronousMachineEquivalentCircuitTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSynchronousMachineEquivalentCircuitCommand generateNewCommand() {
        CreateSynchronousMachineEquivalentCircuitCommand command = new CreateSynchronousMachineEquivalentCircuitCommand( null );
	...
	protected UpdateSynchronousMachineEquivalentCircuitCommand generateUpdateCommand() {
	        UpdateSynchronousMachineEquivalentCircuitCommand command = new UpdateSynchronousMachineEquivalentCircuitCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
