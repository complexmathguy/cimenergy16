...
public class WindPlantReactiveControlIECTest{
	 ...
	 */
	publics WindPlantReactiveControlIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindPlantReactiveControlIECCommand generateNewCommand() {
        CreateWindPlantReactiveControlIECCommand command = new CreateWindPlantReactiveControlIECCommand( null );
	...
	protected UpdateWindPlantReactiveControlIECCommand generateUpdateCommand() {
	        UpdateWindPlantReactiveControlIECCommand command = new UpdateWindPlantReactiveControlIECCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
