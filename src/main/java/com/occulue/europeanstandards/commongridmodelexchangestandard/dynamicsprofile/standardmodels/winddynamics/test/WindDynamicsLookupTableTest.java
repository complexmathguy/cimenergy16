...
public class WindDynamicsLookupTableTest{
	 ...
	 */
	publics WindDynamicsLookupTableTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindDynamicsLookupTableCommand generateNewCommand() {
        CreateWindDynamicsLookupTableCommand command = new CreateWindDynamicsLookupTableCommand( null,  WindLookupTableFunctionKind.values()[0] );
	...
	protected UpdateWindDynamicsLookupTableCommand generateUpdateCommand() {
	        UpdateWindDynamicsLookupTableCommand command = new UpdateWindDynamicsLookupTableCommand( null,  null,  WindLookupTableFunctionKind.values()[0],  null,  null,  new HashSet<>() );
