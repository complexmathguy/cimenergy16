...
public class PFVArControllerType1DynamicsTest{
	 ...
	 */
	publics PFVArControllerType1DynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdatePFVArControllerType1DynamicsCommand generateUpdateCommand() {
	        UpdatePFVArControllerType1DynamicsCommand command = new UpdatePFVArControllerType1DynamicsCommand( null,  null );
