...
public class GovGASTTest{
	 ...
	 * @return		GovGASTTest
	 */
	publics GovGASTTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGovGASTCommand generateNewCommand() {
        CreateGovGASTCommand command = new CreateGovGASTCommand( null );
	...
	protected UpdateGovGASTCommand generateUpdateCommand() {
	        UpdateGovGASTCommand command = new UpdateGovGASTCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
