...
public class ExcELIN1Test{
	 ...
	 * @return		ExcELIN1Test
	 */
	publics ExcELIN1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcELIN1Command generateNewCommand() {
        CreateExcELIN1Command command = new CreateExcELIN1Command( null );
	...
	protected UpdateExcELIN1Command generateUpdateCommand() {
	        UpdateExcELIN1Command command = new UpdateExcELIN1Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
