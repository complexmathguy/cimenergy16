 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.subscriber.*;
...
public class RotatingMachineDynamicsTest{
	 ...
	 */
	publics RotatingMachineDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateRotatingMachineDynamicsCommand generateNewCommand() {
        CreateRotatingMachineDynamicsCommand command = new CreateRotatingMachineDynamicsCommand( null );
	...
	protected UpdateRotatingMachineDynamicsCommand generateUpdateCommand() {
	        UpdateRotatingMachineDynamicsCommand command = new UpdateRotatingMachineDynamicsCommand( null,  null,  null,  null,  null,  null,  null );
