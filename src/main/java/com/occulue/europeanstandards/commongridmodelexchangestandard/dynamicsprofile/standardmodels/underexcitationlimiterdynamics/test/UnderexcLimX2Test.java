...
public class UnderexcLimX2Test{
	 ...
	 */
	publics UnderexcLimX2Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateUnderexcLimX2Command generateNewCommand() {
        CreateUnderexcLimX2Command command = new CreateUnderexcLimX2Command( null );
	...
	protected UpdateUnderexcLimX2Command generateUpdateCommand() {
	        UpdateUnderexcLimX2Command command = new UpdateUnderexcLimX2Command( null,  null,  null,  null,  null,  null,  null,  null );
