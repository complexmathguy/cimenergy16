...
public class WindGenTurbineType3aIECTest{
	 ...
	 */
	publics WindGenTurbineType3aIECTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateWindGenTurbineType3aIECCommand generateNewCommand() {
        CreateWindGenTurbineType3aIECCommand command = new CreateWindGenTurbineType3aIECCommand( null );
	...
	protected UpdateWindGenTurbineType3aIECCommand generateUpdateCommand() {
	        UpdateWindGenTurbineType3aIECCommand command = new UpdateWindGenTurbineType3aIECCommand( null,  null,  null,  null );
