...
public class MechanicalLoadDynamicsTest{
	 ...
	 */
	publics MechanicalLoadDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateMechanicalLoadDynamicsCommand generateUpdateCommand() {
	        UpdateMechanicalLoadDynamicsCommand command = new UpdateMechanicalLoadDynamicsCommand( null,  null );
