...
public class ExcitationSystemUserDefinedTest{
	 ...
	 */
	publics ExcitationSystemUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcitationSystemUserDefinedCommand generateNewCommand() {
        CreateExcitationSystemUserDefinedCommand command = new CreateExcitationSystemUserDefinedCommand( null );
	...
	protected UpdateExcitationSystemUserDefinedCommand generateUpdateCommand() {
	        UpdateExcitationSystemUserDefinedCommand command = new UpdateExcitationSystemUserDefinedCommand( null,  null );
