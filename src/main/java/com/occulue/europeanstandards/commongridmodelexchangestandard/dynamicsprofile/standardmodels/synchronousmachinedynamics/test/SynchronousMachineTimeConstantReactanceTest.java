 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.synchronousmachinedynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.synchronousmachinedynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.synchronousmachinedynamics.subscriber.*;
...
public class SynchronousMachineTimeConstantReactanceTest{
	 ...
	 */
	publics SynchronousMachineTimeConstantReactanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSynchronousMachineTimeConstantReactanceCommand generateNewCommand() {
        CreateSynchronousMachineTimeConstantReactanceCommand command = new CreateSynchronousMachineTimeConstantReactanceCommand( null,  SynchronousMachineModelKind.values()[0],  RotorKind.values()[0] );
	...
	protected UpdateSynchronousMachineTimeConstantReactanceCommand generateUpdateCommand() {
	        UpdateSynchronousMachineTimeConstantReactanceCommand command = new UpdateSynchronousMachineTimeConstantReactanceCommand( null,  null,  SynchronousMachineModelKind.values()[0],  RotorKind.values()[0],  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
