 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.loaddynamics.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.loaddynamics.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.dynamicsprofile.standardmodels.loaddynamics.subscriber.*;
...
public class LoadGenericNonLinearTest{
	 ...
	 */
	publics LoadGenericNonLinearTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLoadGenericNonLinearCommand generateNewCommand() {
        CreateLoadGenericNonLinearCommand command = new CreateLoadGenericNonLinearCommand( null,  GenericNonLinearLoadModelKind.values()[0] );
	...
	protected UpdateLoadGenericNonLinearCommand generateUpdateCommand() {
	        UpdateLoadGenericNonLinearCommand command = new UpdateLoadGenericNonLinearCommand( null,  null,  null,  GenericNonLinearLoadModelKind.values()[0],  null,  null,  null,  null,  null,  null );
