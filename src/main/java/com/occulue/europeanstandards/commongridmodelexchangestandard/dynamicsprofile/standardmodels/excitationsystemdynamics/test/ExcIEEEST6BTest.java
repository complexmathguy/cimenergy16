...
public class ExcIEEEST6BTest{
	 ...
	 */
	publics ExcIEEEST6BTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcIEEEST6BCommand generateNewCommand() {
        CreateExcIEEEST6BCommand command = new CreateExcIEEEST6BCommand( null,  ExcST6BOELselectorKind.values()[0] );
	...
	protected UpdateExcIEEEST6BCommand generateUpdateCommand() {
	        UpdateExcIEEEST6BCommand command = new UpdateExcIEEEST6BCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  ExcST6BOELselectorKind.values()[0],  null,  null,  null,  null,  null );
