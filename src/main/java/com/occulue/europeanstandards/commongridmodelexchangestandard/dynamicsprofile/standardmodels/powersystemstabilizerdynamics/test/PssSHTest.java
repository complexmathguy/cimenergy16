...
public class PssSHTest{
	 ...
	 * @return		PssSHTest
	 */
	publics PssSHTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdatePssSHCommand generateUpdateCommand() {
	        UpdatePssSHCommand command = new UpdatePssSHCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
