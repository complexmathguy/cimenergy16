...
public class PowerSystemStabilizerUserDefinedTest{
	 ...
	 */
	publics PowerSystemStabilizerUserDefinedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePowerSystemStabilizerUserDefinedCommand generateNewCommand() {
        CreatePowerSystemStabilizerUserDefinedCommand command = new CreatePowerSystemStabilizerUserDefinedCommand( null );
	...
	protected UpdatePowerSystemStabilizerUserDefinedCommand generateUpdateCommand() {
	        UpdatePowerSystemStabilizerUserDefinedCommand command = new UpdatePowerSystemStabilizerUserDefinedCommand( null,  null );
