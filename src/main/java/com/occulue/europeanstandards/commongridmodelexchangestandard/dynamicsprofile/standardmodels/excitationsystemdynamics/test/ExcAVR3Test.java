...
public class ExcAVR3Test{
	 ...
	 * @return		ExcAVR3Test
	 */
	publics ExcAVR3Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcAVR3Command generateNewCommand() {
        CreateExcAVR3Command command = new CreateExcAVR3Command( null );
	...
	protected UpdateExcAVR3Command generateUpdateCommand() {
	        UpdateExcAVR3Command command = new UpdateExcAVR3Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
