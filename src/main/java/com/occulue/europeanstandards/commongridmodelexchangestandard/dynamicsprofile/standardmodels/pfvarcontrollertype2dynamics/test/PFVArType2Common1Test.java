...
public class PFVArType2Common1Test{
	 ...
	 */
	publics PFVArType2Common1Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePFVArType2Common1Command generateNewCommand() {
        CreatePFVArType2Common1Command command = new CreatePFVArType2Common1Command( null );
	...
	protected UpdatePFVArType2Common1Command generateUpdateCommand() {
	        UpdatePFVArType2Common1Command command = new UpdatePFVArType2Common1Command( null,  null,  null,  null,  null,  null );
