...
public class TurbineLoadControllerDynamicsTest{
	 ...
	 */
	publics TurbineLoadControllerDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateTurbineLoadControllerDynamicsCommand generateUpdateCommand() {
	        UpdateTurbineLoadControllerDynamicsCommand command = new UpdateTurbineLoadControllerDynamicsCommand( null,  null );
