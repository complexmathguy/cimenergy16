...
public class ExcAVR4Test{
	 ...
	 * @return		ExcAVR4Test
	 */
	publics ExcAVR4Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateExcAVR4Command generateNewCommand() {
        CreateExcAVR4Command command = new CreateExcAVR4Command( null );
	...
	protected UpdateExcAVR4Command generateUpdateCommand() {
	        UpdateExcAVR4Command command = new UpdateExcAVR4Command( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
