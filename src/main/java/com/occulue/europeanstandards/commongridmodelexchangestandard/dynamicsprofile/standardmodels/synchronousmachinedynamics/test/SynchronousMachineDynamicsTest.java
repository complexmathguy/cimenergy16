...
public class SynchronousMachineDynamicsTest{
	 ...
	 */
	publics SynchronousMachineDynamicsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateSynchronousMachineDynamicsCommand generateUpdateCommand() {
	        UpdateSynchronousMachineDynamicsCommand command = new UpdateSynchronousMachineDynamicsCommand( null,  null );
