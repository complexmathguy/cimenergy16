...
public class GovSteam0Test{
	 ...
	 */
	publics GovSteam0Test setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGovSteam0Command generateNewCommand() {
        CreateGovSteam0Command command = new CreateGovSteam0Command( null );
	...
	protected UpdateGovSteam0Command generateUpdateCommand() {
	        UpdateGovSteam0Command command = new UpdateGovSteam0Command( null,  null,  null,  null,  null,  null,  null,  null,  null );
