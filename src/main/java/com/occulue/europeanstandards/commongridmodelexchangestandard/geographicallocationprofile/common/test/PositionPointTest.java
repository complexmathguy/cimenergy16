 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.geographicallocationprofile.common.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.geographicallocationprofile.common.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.geographicallocationprofile.common.subscriber.*;
...
public class PositionPointTest{
	 ...
	 */
	publics PositionPointTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePositionPointCommand generateNewCommand() {
        CreatePositionPointCommand command = new CreatePositionPointCommand( null );
	...
	protected UpdatePositionPointCommand generateUpdateCommand() {
	        UpdatePositionPointCommand command = new UpdatePositionPointCommand( null,  null,  null,  null,  null,  new HashSet<>() );
