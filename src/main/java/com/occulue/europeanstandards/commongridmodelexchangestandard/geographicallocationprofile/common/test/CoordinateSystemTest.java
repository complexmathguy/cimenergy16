...
public class CoordinateSystemTest{
	 ...
	 */
	publics CoordinateSystemTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCoordinateSystemCommand generateNewCommand() {
        CreateCoordinateSystemCommand command = new CreateCoordinateSystemCommand( null );
	...
	protected UpdateCoordinateSystemCommand generateUpdateCommand() {
	        UpdateCoordinateSystemCommand command = new UpdateCoordinateSystemCommand( null,  null );
