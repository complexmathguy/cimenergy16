 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.geographicallocationprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.geographicallocationprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.geographicallocationprofile.subscriber.*;
...
public class GeographicalLocationVersionTest{
	 ...
	 */
	publics GeographicalLocationVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateGeographicalLocationVersionCommand generateNewCommand() {
        CreateGeographicalLocationVersionCommand command = new CreateGeographicalLocationVersionCommand( null );
	...
	protected UpdateGeographicalLocationVersionCommand generateUpdateCommand() {
	        UpdateGeographicalLocationVersionCommand command = new UpdateGeographicalLocationVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
