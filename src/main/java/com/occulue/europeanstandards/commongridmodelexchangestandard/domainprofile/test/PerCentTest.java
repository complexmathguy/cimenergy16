...
public class PerCentTest{
	 ...
	 * @return		PerCentTest
	 */
	publics PerCentTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePerCentCommand generateNewCommand() {
        CreatePerCentCommand command = new CreatePerCentCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdatePerCentCommand generateUpdateCommand() {
	        UpdatePerCentCommand command = new UpdatePerCentCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
