...
public class DomainVersionTest{
	 ...
	 */
	publics DomainVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateDomainVersionCommand generateNewCommand() {
        CreateDomainVersionCommand command = new CreateDomainVersionCommand( null );
	...
	protected UpdateDomainVersionCommand generateUpdateCommand() {
	        UpdateDomainVersionCommand command = new UpdateDomainVersionCommand( null,  null,  null,  null,  null );
