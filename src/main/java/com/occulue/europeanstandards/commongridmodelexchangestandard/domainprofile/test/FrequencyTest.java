...
public class FrequencyTest{
	 ...
	 */
	publics FrequencyTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateFrequencyCommand generateNewCommand() {
        CreateFrequencyCommand command = new CreateFrequencyCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateFrequencyCommand generateUpdateCommand() {
	        UpdateFrequencyCommand command = new UpdateFrequencyCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
