...
public class AreaTest{
	 ...
	 * @return		AreaTest
	 */
	publics AreaTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAreaCommand generateNewCommand() {
        CreateAreaCommand command = new CreateAreaCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateAreaCommand generateUpdateCommand() {
	        UpdateAreaCommand command = new UpdateAreaCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
