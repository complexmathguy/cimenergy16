...
public class ResistanceTest{
	 ...
	 */
	publics ResistanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateResistanceCommand generateNewCommand() {
        CreateResistanceCommand command = new CreateResistanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateResistanceCommand generateUpdateCommand() {
	        UpdateResistanceCommand command = new UpdateResistanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
