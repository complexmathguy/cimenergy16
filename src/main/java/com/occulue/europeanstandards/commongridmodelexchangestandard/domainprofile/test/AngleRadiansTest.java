...
public class AngleRadiansTest{
	 ...
	 */
	publics AngleRadiansTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAngleRadiansCommand generateNewCommand() {
        CreateAngleRadiansCommand command = new CreateAngleRadiansCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateAngleRadiansCommand generateUpdateCommand() {
	        UpdateAngleRadiansCommand command = new UpdateAngleRadiansCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
