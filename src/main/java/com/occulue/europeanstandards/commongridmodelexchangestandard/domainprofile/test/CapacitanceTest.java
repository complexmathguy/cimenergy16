...
public class CapacitanceTest{
	 ...
	 */
	publics CapacitanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCapacitanceCommand generateNewCommand() {
        CreateCapacitanceCommand command = new CreateCapacitanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateCapacitanceCommand generateUpdateCommand() {
	        UpdateCapacitanceCommand command = new UpdateCapacitanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
