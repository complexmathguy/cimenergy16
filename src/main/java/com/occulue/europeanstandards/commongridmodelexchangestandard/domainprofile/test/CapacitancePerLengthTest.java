...
public class CapacitancePerLengthTest{
	 ...
	 */
	publics CapacitancePerLengthTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCapacitancePerLengthCommand generateNewCommand() {
        CreateCapacitancePerLengthCommand command = new CreateCapacitancePerLengthCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateCapacitancePerLengthCommand generateUpdateCommand() {
	        UpdateCapacitancePerLengthCommand command = new UpdateCapacitancePerLengthCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
