...
public class ConductanceTest{
	 ...
	 */
	publics ConductanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateConductanceCommand generateNewCommand() {
        CreateConductanceCommand command = new CreateConductanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateConductanceCommand generateUpdateCommand() {
	        UpdateConductanceCommand command = new UpdateConductanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
