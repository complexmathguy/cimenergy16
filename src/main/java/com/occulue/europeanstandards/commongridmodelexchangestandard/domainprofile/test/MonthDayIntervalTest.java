...
public class MonthDayIntervalTest{
	 ...
	 */
	publics MonthDayIntervalTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateMonthDayIntervalCommand generateNewCommand() {
        CreateMonthDayIntervalCommand command = new CreateMonthDayIntervalCommand( null );
	...
	protected UpdateMonthDayIntervalCommand generateUpdateCommand() {
	        UpdateMonthDayIntervalCommand command = new UpdateMonthDayIntervalCommand( null,  null,  null );
