...
public class SusceptanceTest{
	 ...
	 */
	publics SusceptanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSusceptanceCommand generateNewCommand() {
        CreateSusceptanceCommand command = new CreateSusceptanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateSusceptanceCommand generateUpdateCommand() {
	        UpdateSusceptanceCommand command = new UpdateSusceptanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
