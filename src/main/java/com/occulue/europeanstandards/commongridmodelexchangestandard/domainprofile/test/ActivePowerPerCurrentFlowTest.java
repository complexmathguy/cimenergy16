...
public class ActivePowerPerCurrentFlowTest{
	 ...
	 */
	publics ActivePowerPerCurrentFlowTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateActivePowerPerCurrentFlowCommand generateNewCommand() {
        CreateActivePowerPerCurrentFlowCommand command = new CreateActivePowerPerCurrentFlowCommand( null );
	...
	protected UpdateActivePowerPerCurrentFlowCommand generateUpdateCommand() {
	        UpdateActivePowerPerCurrentFlowCommand command = new UpdateActivePowerPerCurrentFlowCommand( null );
