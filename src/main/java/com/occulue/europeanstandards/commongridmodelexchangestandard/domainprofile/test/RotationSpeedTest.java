...
public class RotationSpeedTest{
	 ...
	 */
	publics RotationSpeedTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateRotationSpeedCommand generateNewCommand() {
        CreateRotationSpeedCommand command = new CreateRotationSpeedCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateRotationSpeedCommand generateUpdateCommand() {
	        UpdateRotationSpeedCommand command = new UpdateRotationSpeedCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
