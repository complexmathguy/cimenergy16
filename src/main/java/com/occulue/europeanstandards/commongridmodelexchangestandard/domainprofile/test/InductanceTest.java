...
public class InductanceTest{
	 ...
	 */
	publics InductanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateInductanceCommand generateNewCommand() {
        CreateInductanceCommand command = new CreateInductanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateInductanceCommand generateUpdateCommand() {
	        UpdateInductanceCommand command = new UpdateInductanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
