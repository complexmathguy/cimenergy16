...
public class Simple_FloatTest{
	 ...
	 */
	publics Simple_FloatTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSimple_FloatCommand generateNewCommand() {
        CreateSimple_FloatCommand command = new CreateSimple_FloatCommand( null );
	...
	protected UpdateSimple_FloatCommand generateUpdateCommand() {
	        UpdateSimple_FloatCommand command = new UpdateSimple_FloatCommand( null,  null );
