...
public class LengthTest{
	 ...
	 * @return		LengthTest
	 */
	publics LengthTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateLengthCommand generateNewCommand() {
        CreateLengthCommand command = new CreateLengthCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateLengthCommand generateUpdateCommand() {
	        UpdateLengthCommand command = new UpdateLengthCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
