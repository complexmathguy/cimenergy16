...
public class ReactivePowerTest{
	 ...
	 */
	publics ReactivePowerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateReactivePowerCommand generateNewCommand() {
        CreateReactivePowerCommand command = new CreateReactivePowerCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateReactivePowerCommand generateUpdateCommand() {
	        UpdateReactivePowerCommand command = new UpdateReactivePowerCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
