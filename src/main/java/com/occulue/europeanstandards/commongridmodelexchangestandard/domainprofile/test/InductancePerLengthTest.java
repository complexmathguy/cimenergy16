...
public class InductancePerLengthTest{
	 ...
	 */
	publics InductancePerLengthTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateInductancePerLengthCommand generateNewCommand() {
        CreateInductancePerLengthCommand command = new CreateInductancePerLengthCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateInductancePerLengthCommand generateUpdateCommand() {
	        UpdateInductancePerLengthCommand command = new UpdateInductancePerLengthCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
