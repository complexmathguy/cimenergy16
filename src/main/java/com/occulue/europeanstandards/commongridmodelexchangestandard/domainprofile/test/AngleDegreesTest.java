...
public class AngleDegreesTest{
	 ...
	 */
	publics AngleDegreesTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateAngleDegreesCommand generateNewCommand() {
        CreateAngleDegreesCommand command = new CreateAngleDegreesCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateAngleDegreesCommand generateUpdateCommand() {
	        UpdateAngleDegreesCommand command = new UpdateAngleDegreesCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
