...
public class ResistancePerLengthTest{
	 ...
	 */
	publics ResistancePerLengthTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateResistancePerLengthCommand generateNewCommand() {
        CreateResistancePerLengthCommand command = new CreateResistancePerLengthCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateResistancePerLengthCommand generateUpdateCommand() {
	        UpdateResistancePerLengthCommand command = new UpdateResistancePerLengthCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
