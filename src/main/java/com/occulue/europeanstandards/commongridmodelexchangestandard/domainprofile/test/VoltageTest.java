...
public class VoltageTest{
	 ...
	 * @return		VoltageTest
	 */
	publics VoltageTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVoltageCommand generateNewCommand() {
        CreateVoltageCommand command = new CreateVoltageCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateVoltageCommand generateUpdateCommand() {
	        UpdateVoltageCommand command = new UpdateVoltageCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
