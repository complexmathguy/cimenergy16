 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.domainprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.domainprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.domainprofile.subscriber.*;
...
public class ActivePowerPerFrequencyTest{
	 ...
	 */
	publics ActivePowerPerFrequencyTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateActivePowerPerFrequencyCommand generateNewCommand() {
        CreateActivePowerPerFrequencyCommand command = new CreateActivePowerPerFrequencyCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateActivePowerPerFrequencyCommand generateUpdateCommand() {
	        UpdateActivePowerPerFrequencyCommand command = new UpdateActivePowerPerFrequencyCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
