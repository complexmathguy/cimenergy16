...
public class PUTest{
	 ...
	 * @return		PUTest
	 */
	publics PUTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreatePUCommand generateNewCommand() {
        CreatePUCommand command = new CreatePUCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdatePUCommand generateUpdateCommand() {
	        UpdatePUCommand command = new UpdatePUCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
