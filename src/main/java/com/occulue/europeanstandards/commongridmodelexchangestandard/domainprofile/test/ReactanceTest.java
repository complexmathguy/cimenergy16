...
public class ReactanceTest{
	 ...
	 */
	publics ReactanceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateReactanceCommand generateNewCommand() {
        CreateReactanceCommand command = new CreateReactanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateReactanceCommand generateUpdateCommand() {
	        UpdateReactanceCommand command = new UpdateReactanceCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
