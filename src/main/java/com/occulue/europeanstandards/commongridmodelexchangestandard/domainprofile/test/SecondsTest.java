...
public class SecondsTest{
	 ...
	 * @return		SecondsTest
	 */
	publics SecondsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSecondsCommand generateNewCommand() {
        CreateSecondsCommand command = new CreateSecondsCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateSecondsCommand generateUpdateCommand() {
	        UpdateSecondsCommand command = new UpdateSecondsCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
