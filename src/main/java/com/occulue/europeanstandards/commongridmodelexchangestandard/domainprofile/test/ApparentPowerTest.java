...
public class ApparentPowerTest{
	 ...
	 */
	publics ApparentPowerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateApparentPowerCommand generateNewCommand() {
        CreateApparentPowerCommand command = new CreateApparentPowerCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateApparentPowerCommand generateUpdateCommand() {
	        UpdateApparentPowerCommand command = new UpdateApparentPowerCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
