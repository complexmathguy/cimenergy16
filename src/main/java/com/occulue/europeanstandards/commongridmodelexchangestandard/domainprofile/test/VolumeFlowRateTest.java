...
public class VolumeFlowRateTest{
	 ...
	 */
	publics VolumeFlowRateTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateVolumeFlowRateCommand generateNewCommand() {
        CreateVolumeFlowRateCommand command = new CreateVolumeFlowRateCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateVolumeFlowRateCommand generateUpdateCommand() {
	        UpdateVolumeFlowRateCommand command = new UpdateVolumeFlowRateCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
