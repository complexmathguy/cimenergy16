...
public class TemperatureTest{
	 ...
	 */
	publics TemperatureTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateTemperatureCommand generateNewCommand() {
        CreateTemperatureCommand command = new CreateTemperatureCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateTemperatureCommand generateUpdateCommand() {
	        UpdateTemperatureCommand command = new UpdateTemperatureCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
