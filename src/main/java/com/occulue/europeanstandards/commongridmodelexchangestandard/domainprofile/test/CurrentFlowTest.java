...
public class CurrentFlowTest{
	 ...
	 */
	publics CurrentFlowTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateCurrentFlowCommand generateNewCommand() {
        CreateCurrentFlowCommand command = new CreateCurrentFlowCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateCurrentFlowCommand generateUpdateCommand() {
	        UpdateCurrentFlowCommand command = new UpdateCurrentFlowCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
