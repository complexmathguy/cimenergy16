...
public class ActivePowerTest{
	 ...
	 */
	publics ActivePowerTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateActivePowerCommand generateNewCommand() {
        CreateActivePowerCommand command = new CreateActivePowerCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0] );
	...
	protected UpdateActivePowerCommand generateUpdateCommand() {
	        UpdateActivePowerCommand command = new UpdateActivePowerCommand( null,  UnitMultiplier.values()[0],  UnitSymbol.values()[0],  null );
