...
public class MoneyTest{
	 ...
	 * @return		MoneyTest
	 */
	publics MoneyTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateMoneyCommand generateNewCommand() {
        CreateMoneyCommand command = new CreateMoneyCommand( null,  UnitMultiplier.values()[0],  CurrencyEnum.values()[0] );
	...
	protected UpdateMoneyCommand generateUpdateCommand() {
	        UpdateMoneyCommand command = new UpdateMoneyCommand( null,  UnitMultiplier.values()[0],  CurrencyEnum.values()[0],  null );
