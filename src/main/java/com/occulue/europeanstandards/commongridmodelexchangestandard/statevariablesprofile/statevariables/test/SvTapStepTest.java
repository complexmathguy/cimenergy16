...
public class SvTapStepTest{
	 ...
	 */
	publics SvTapStepTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSvTapStepCommand generateNewCommand() {
        CreateSvTapStepCommand command = new CreateSvTapStepCommand( null );
	...
	protected UpdateSvTapStepCommand generateUpdateCommand() {
	        UpdateSvTapStepCommand command = new UpdateSvTapStepCommand( null,  null,  null );
