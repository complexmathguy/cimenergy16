...
public class SvStatusTest{
	 ...
	 * @return		SvStatusTest
	 */
	publics SvStatusTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSvStatusCommand generateNewCommand() {
        CreateSvStatusCommand command = new CreateSvStatusCommand( null );
	...
	protected UpdateSvStatusCommand generateUpdateCommand() {
	        UpdateSvStatusCommand command = new UpdateSvStatusCommand( null,  null,  null );
