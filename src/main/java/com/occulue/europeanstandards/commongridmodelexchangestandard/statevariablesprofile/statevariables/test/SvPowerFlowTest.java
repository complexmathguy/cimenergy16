...
public class SvPowerFlowTest{
	 ...
	 */
	publics SvPowerFlowTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSvPowerFlowCommand generateNewCommand() {
        CreateSvPowerFlowCommand command = new CreateSvPowerFlowCommand( null );
	...
	protected UpdateSvPowerFlowCommand generateUpdateCommand() {
	        UpdateSvPowerFlowCommand command = new UpdateSvPowerFlowCommand( null,  null,  null,  null );
