...
public class SvVoltageTest{
	 ...
	 */
	publics SvVoltageTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSvVoltageCommand generateNewCommand() {
        CreateSvVoltageCommand command = new CreateSvVoltageCommand( null );
	...
	protected UpdateSvVoltageCommand generateUpdateCommand() {
	        UpdateSvVoltageCommand command = new UpdateSvVoltageCommand( null,  null,  null,  null );
