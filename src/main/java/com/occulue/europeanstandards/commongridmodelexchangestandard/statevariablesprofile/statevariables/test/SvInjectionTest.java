...
public class SvInjectionTest{
	 ...
	 */
	publics SvInjectionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSvInjectionCommand generateNewCommand() {
        CreateSvInjectionCommand command = new CreateSvInjectionCommand( null );
	...
	protected UpdateSvInjectionCommand generateUpdateCommand() {
	        UpdateSvInjectionCommand command = new UpdateSvInjectionCommand( null,  null,  null,  null );
