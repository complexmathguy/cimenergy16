 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.topology.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.topology.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.topology.subscriber.*;
...
public class TopologicalIslandTest{
	 ...
	 */
	publics TopologicalIslandTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateTopologicalIslandCommand generateUpdateCommand() {
	        UpdateTopologicalIslandCommand command = new UpdateTopologicalIslandCommand( null,  null,  null );
