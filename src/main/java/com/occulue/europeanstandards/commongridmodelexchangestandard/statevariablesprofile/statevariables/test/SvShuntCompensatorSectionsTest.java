 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.statevariables.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.statevariables.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.statevariables.subscriber.*;
...
public class SvShuntCompensatorSectionsTest{
	 ...
	 */
	publics SvShuntCompensatorSectionsTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSvShuntCompensatorSectionsCommand generateNewCommand() {
        CreateSvShuntCompensatorSectionsCommand command = new CreateSvShuntCompensatorSectionsCommand( null );
	...
	protected UpdateSvShuntCompensatorSectionsCommand generateUpdateCommand() {
	        UpdateSvShuntCompensatorSectionsCommand command = new UpdateSvShuntCompensatorSectionsCommand( null,  null,  null );
