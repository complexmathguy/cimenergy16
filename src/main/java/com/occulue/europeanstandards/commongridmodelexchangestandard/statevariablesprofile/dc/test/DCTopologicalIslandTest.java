 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.dc.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.dc.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.dc.subscriber.*;
...
public class DCTopologicalIslandTest{
	 ...
	 */
	publics DCTopologicalIslandTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateDCTopologicalIslandCommand generateUpdateCommand() {
	        UpdateDCTopologicalIslandCommand command = new UpdateDCTopologicalIslandCommand( null,  null );
