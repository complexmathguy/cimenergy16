 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.statevariablesprofile.subscriber.*;
...
public class StateVariablesVersionTest{
	 ...
	 */
	publics StateVariablesVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateStateVariablesVersionCommand generateNewCommand() {
        CreateStateVariablesVersionCommand command = new CreateStateVariablesVersionCommand( null );
	...
	protected UpdateStateVariablesVersionCommand generateUpdateCommand() {
	        UpdateStateVariablesVersionCommand command = new UpdateStateVariablesVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
