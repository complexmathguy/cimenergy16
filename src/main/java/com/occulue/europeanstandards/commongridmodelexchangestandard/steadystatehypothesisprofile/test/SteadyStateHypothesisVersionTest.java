 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.steadystatehypothesisprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.steadystatehypothesisprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.steadystatehypothesisprofile.subscriber.*;
...
public class SteadyStateHypothesisVersionTest{
	 ...
	 */
	publics SteadyStateHypothesisVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSteadyStateHypothesisVersionCommand generateNewCommand() {
        CreateSteadyStateHypothesisVersionCommand command = new CreateSteadyStateHypothesisVersionCommand( null );
	...
	protected UpdateSteadyStateHypothesisVersionCommand generateUpdateCommand() {
	        UpdateSteadyStateHypothesisVersionCommand command = new UpdateSteadyStateHypothesisVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
