 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.steadystatehypothesisprofile.wires.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.steadystatehypothesisprofile.wires.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.steadystatehypothesisprofile.wires.subscriber.*;
...
public class SwitchItTest{
	 ...
	 * @return		SwitchItTest
	 */
	publics SwitchItTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateSwitchItCommand generateNewCommand() {
        CreateSwitchItCommand command = new CreateSwitchItCommand( null );
	...
	protected UpdateSwitchItCommand generateUpdateCommand() {
	        UpdateSwitchItCommand command = new UpdateSwitchItCommand( null,  null );
