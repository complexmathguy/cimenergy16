 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.core.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.core.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.core.subscriber.*;
...
public class ConnectivityNodeTest{
	 ...
	 */
	publics ConnectivityNodeTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateConnectivityNodeCommand generateNewCommand() {
        CreateConnectivityNodeCommand command = new CreateConnectivityNodeCommand( null );
	...
	protected UpdateConnectivityNodeCommand generateUpdateCommand() {
	        UpdateConnectivityNodeCommand command = new UpdateConnectivityNodeCommand( null,  null,  null,  null,  null,  null,  null,  null,  new HashSet<>() );
