 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.wires.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.wires.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.wires.subscriber.*;
...
public class EnergySourceTest{
	 ...
	 */
	publics EnergySourceTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateEnergySourceCommand generateUpdateCommand() {
	        UpdateEnergySourceCommand command = new UpdateEnergySourceCommand( null,  new HashSet<>() );
