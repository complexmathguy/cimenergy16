...
public class IdentifiedObjectTest{
	 ...
	 */
	publics IdentifiedObjectTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateIdentifiedObjectCommand generateNewCommand() {
        CreateIdentifiedObjectCommand command = new CreateIdentifiedObjectCommand( null );
	...
	protected UpdateIdentifiedObjectCommand generateUpdateCommand() {
	        UpdateIdentifiedObjectCommand command = new UpdateIdentifiedObjectCommand( null,  null,  null,  null,  null,  null );
