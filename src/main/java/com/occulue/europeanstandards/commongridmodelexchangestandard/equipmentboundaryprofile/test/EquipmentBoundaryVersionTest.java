 ...
 ******************************************************************************/
package com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.test;
...
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.delegate.*;
import com.occulue.entity.*;
import com.occulue.api.*;
import com.occulue.europeanstandards.commongridmodelexchangestandard.equipmentboundaryprofile.subscriber.*;
...
public class EquipmentBoundaryVersionTest{
	 ...
	 */
	publics EquipmentBoundaryVersionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateEquipmentBoundaryVersionCommand generateNewCommand() {
        CreateEquipmentBoundaryVersionCommand command = new CreateEquipmentBoundaryVersionCommand( null );
	...
	protected UpdateEquipmentBoundaryVersionCommand generateUpdateCommand() {
	        UpdateEquipmentBoundaryVersionCommand command = new UpdateEquipmentBoundaryVersionCommand( null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null,  null );
