...
public class BaseVoltageTest{
	 ...
	 */
	publics BaseVoltageTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected CreateBaseVoltageCommand generateNewCommand() {
        CreateBaseVoltageCommand command = new CreateBaseVoltageCommand( null );
	...
	protected UpdateBaseVoltageCommand generateUpdateCommand() {
	        UpdateBaseVoltageCommand command = new UpdateBaseVoltageCommand( null,  null );
