...
public class SubGeographicalRegionTest{
	 ...
	 */
	publics SubGeographicalRegionTest setHandler(Handler handler) {
		if ( handler != null )
	...
	protected UpdateSubGeographicalRegionCommand generateUpdateCommand() {
	        UpdateSubGeographicalRegionCommand command = new UpdateSubGeographicalRegionCommand( null,  new HashSet<>() );
